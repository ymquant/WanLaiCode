...
describe("plugin.meta", () => {
  test("tracks file plugin loads and changes", async () => {
    ...
    process.env.WANLAICODE_PLUGIN_META_FILE = path.join(tmp.path, "state", "plugin-meta.json")
    const file = (process.env.WANLAICODE_PLUGIN_META_FILE ?? process.env.OPENCODE_PLUGIN_META_FILE)!

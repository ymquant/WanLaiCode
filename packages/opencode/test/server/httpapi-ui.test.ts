...
const original = {
  ...
  OPENCODE_DISABLE_EMBEDDED_WEB_UI: Flag.WANLAICODE_DISABLE_EMBEDDED_WEB_UI,
...
afterEach(() => {
  ...
  Flag.WANLAICODE_DISABLE_EMBEDDED_WEB_UI = original.OPENCODE_DISABLE_EMBEDDED_WEB_UI
...
describe("HttpApi UI fallback", () => {
  test("serves the web UI through the experimental backend", async () => {
    ...
    Flag.WANLAICODE_DISABLE_EMBEDDED_WEB_UI = true
  ...
  test("requires server password for the web UI", async () => {
    ...
    const response = await uiApp({ password: "secret", username: "wanlaicode" }).request("/")
  ...
  test("accepts auth token for the web UI", async () => {
    ...
    }).request(`/?auth_token=${btoa("wanlaicode:secret")}`)
  ...
  test("accepts basic auth for the web UI", async () => {
    ...
    const response = await uiApp({ password: "secret", username: "wanlaicode" }).request("/", {
      headers: { authorization: `Basic ${btoa("wanlaicode:secret")}` },
    })
  ...
  test("allows web UI preflight without auth", async () => {
    ...
    const response = await app({ password: "secret", username: "wanlaicode" }).request("/", {
      method: "OPTIONS",
      headers: {

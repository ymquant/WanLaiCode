...
const testMcpHandlers = HttpApiBuilder.group(TestHttpApi, "mcp", (handlers) =>
  Effect.succeed(
    handlers
      ...
      .handle("managementList", () => Effect.die("unexpected MCP managementList"))
      .handle("managementGet", () => Effect.die("unexpected MCP managementGet"))
      .handle("managementSave", () => Effect.die("unexpected MCP managementSave"))
      .handle("managementRemove", () => Effect.die("unexpected MCP managementRemove"))
      .handle("managementToggle", () => Effect.die("unexpected MCP managementToggle"))
      .handle("authStart", () =>

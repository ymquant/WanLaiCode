...
const proxyFetch = NetProxy.create("Cli.github")
        ...
        function printNextSteps() {
          ...
          prompts.outro(
            [
              ...
              "",
              "   Learn more about the GitHub agent - https://doc.wanlai.ai/",
            ].join("\n"),
          )
        }
    ...
    yield* Effect.promise(async () => {
      ...
      function generateBranchName(type: "issue" | "pr" | "schedule" | "dispatch") {
        ...
        if (type === "schedule" || type === "dispatch") {
          ...
          return `wanlaicode/${type}-${hex}-${timestamp}`
        }
        return `wanlaicode/${type}${issueId}-${timestamp}`
      }

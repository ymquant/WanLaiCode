...
export namespace Text {
  // 与 Responses agent message 使用同一阶段枚举，事件投影才能稳定区分活动说明和最终回答。
  export const Phase = Schema.Literals(["commentary", "final_answer"])
  ...
  export const Started = EventV2.define({
    ...
    schema: {
      ...Base,
      phase: Phase.pipe(Schema.optional),
    },
  })
  export type Started = Schema.Schema.Type<typeof Started>
...
export namespace Tool {
  ...
  export const Failed = EventV2.define({
    ...
    schema: {
      ...Base,
      callID: Schema.String,
      content: ToolOutput.Content.pipe(Schema.Array, Schema.optional),
      structured: ToolOutput.Structured.pipe(Schema.optional),
      error: UnknownError,
      provider: Schema.Struct({
        executed: Schema.Boolean,
        metadata: Schema.Record(Schema.String, Schema.Unknown).pipe(Schema.optional),

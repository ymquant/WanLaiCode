...
export const USER_AGENT = `opencode/${InstallationChannel}/${InstallationVersion}/${Flag.WANLAICODE_CLIENT}`
    ...
    Effect.gen(function* () {
      ...
      const result: Interface = {
        ...
        method: Effect.fn("Installation.method")(function* () {
          if (process.execPath.includes(path.join(".wanlaicode", "bin"))) return "curl" as Method

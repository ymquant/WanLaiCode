...
/** Path relative to the project root used for titles, diffs, and permission patterns. */
export function relativeToProject(filepath: string, ctx: InstanceContext): string {

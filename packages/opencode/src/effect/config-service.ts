 ...
 *   {
 *     password: Config.string("WANLAICODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("WANLAICODE_SERVER_USERNAME").pipe(Config.withDefault("wanlaicode")),
 *   },
 * ) {}
 *

...
export default defineConfig({
  plugins: [
    ...
    iconsSpritesheet([
      ...
      {
        withTypes: true,
        inputDir: "src/assets/icons/file-types-easy",
        outputDir: "src/components/file-icons-easy",
        formatter: "prettier",
      },
      {
        withTypes: true,
...
async function fetchProviderIcons() {
  const url = (process.env.WANLAICODE_MODELS_URL ?? process.env.OPENCODE_MODELS_URL) || "https://models.dev"

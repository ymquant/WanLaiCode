...
import { WanlaiMarkGray } from "../brand/logo-wanlai"
...
export const LineComment = (props: LineCommentProps) => {
  const i18n = useI18n()
  const [split, rest] = splitProps(props, ["comment", "selection", "actions", "title"])

  return (
    <LineCommentAnchor {...rest} variant="default" hideButton={props.inline}>
      <div data-slot="line-comment-content">
        <div data-slot="line-comment-header">
          <div data-slot="line-comment-meta">
            <div data-slot="line-comment-title-group">
              <span data-slot="line-comment-title-icon">
                <WanlaiMarkGray class="size-4" />
              </span>
              <div data-slot="line-comment-title">{split.title ?? i18n.t("ui.lineComment.localTitle")}</div>
            </div>
          ...
          <div data-slot="line-comment-divider" />
        </div>
        <div data-slot="line-comment-body">
      ...
      <div data-slot="line-comment-editor">
        ...
        <div data-slot="line-comment-footer">
          <div data-slot="line-comment-actions">
            <Show when={split.onDelete}>
              <button
                type="button"
                data-slot="line-comment-action"
                data-variant="danger-soft"
                on:mousedown={hold as any}
                on:click={click(split.onDelete!) as any}
              >
                {split.deleteLabel ?? i18n.t("ui.common.delete")}
              </button>
            </Show>
            <div data-slot="line-comment-actions-spacer" />
            <button
              type="button"
              data-slot="line-comment-action"
              data-variant="ghost"
          ...
          >
            <Button size="small" variant="ghost" class="hidden" onClick={split.onCancel}>
              {split.cancelLabel ?? i18n.t("ui.common.cancel")}
            </Button>
            <Button
              size="small"

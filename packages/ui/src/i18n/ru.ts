export const dict = {
  ...
  "ui.message.stoppedAfter": "Вы остановили через {{duration}}",
  ...
  "ui.question.multiHint.selected": "Множественный выбор · выбрано {{count}}",
  "ui.question.badge.selected": "Выбрано",
  "ui.question.badge.recommended": "Рекомендуется",
  "ui.question.action.skip": "Пропустить",

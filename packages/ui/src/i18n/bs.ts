...
export const dict = {
  ...
  "ui.message.stoppedAfter": "Zaustavili ste nakon {{duration}}",
  ...
  "ui.question.multiHint.selected": "Višestruki odabir · odabrano {{count}}",
  "ui.question.badge.selected": "Odabrano",
  "ui.question.badge.recommended": "Preporučeno",
  "ui.question.action.skip": "Preskoči",

export const dict = {
  ...
  "ui.message.stoppedAfter": "Vous avez arrêté après {{duration}}",
  ...
  "ui.question.multiHint.selected": "Choix multiple · {{count}} sélectionné(s)",
  "ui.question.badge.selected": "Sélectionné",
  "ui.question.badge.recommended": "Recommandé",
  "ui.question.action.skip": "Passer",

export const dict = {
  ...
  "desktop.contextMenu.saveImageAs": "Guardar imagen como...",
  "desktop.contextMenu.copyImage": "Copiar imagen",
  "desktop.contextMenu.inspect": "Inspeccionar elemento",
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de {{appName}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de {{appName}}. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.updater.progress.windowTitle": "Actualizando {{appName}}",
  "desktop.updater.progress.preparing": "Preparando actualización...",
  "desktop.updater.progress.downloading": "Descargando actualización...",
  "desktop.updater.progress.installing": "Instalando actualización...",
  "desktop.updater.progress.failed": "Actualización fallida",
  "desktop.updater.progress.cancelled": "Actualización cancelada",
  "desktop.updater.progress.cancel": "Cancelar",
  "desktop.updater.progress.close": "Cerrar",

  "desktop.cli.installed.title": "CLI instalada",
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando '{{appName}}'.",
  "desktop.cli.failed.title": "Instalación fallida",
  "desktop.cli.failed.message": "No se pudo instalar la CLI: {{error}}",

  "desktop.tray.recent": "Recientes",
  "desktop.tray.more": "Más",
  "desktop.tray.open": "Abrir {{appName}}",
}

export const dict = {
  ...
  "desktop.contextMenu.saveImageAs": "Lagre bilde som...",
  "desktop.contextMenu.copyImage": "Kopier bilde",
  "desktop.contextMenu.inspect": "Inspiser element",
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av {{appName}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av {{appName}} er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.updater.progress.windowTitle": "Oppdaterer {{appName}}",
  "desktop.updater.progress.preparing": "Forbereder oppdatering...",
  "desktop.updater.progress.downloading": "Laster ned oppdatering...",
  "desktop.updater.progress.installing": "Installerer oppdatering...",
  "desktop.updater.progress.failed": "Oppdatering mislyktes",
  "desktop.updater.progress.cancelled": "Oppdatering avbrutt",
  "desktop.updater.progress.cancel": "Avbryt",
  "desktop.updater.progress.close": "Lukk",

  "desktop.cli.installed.title": "CLI installert",
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke '{{appName}}'-kommandoen.",
  "desktop.cli.failed.title": "Installasjon mislyktes",
  "desktop.cli.failed.message": "Kunne ikke installere CLI: {{error}}",

  "desktop.tray.recent": "Nylige",
  "desktop.tray.more": "Mer",
  "desktop.tray.open": "Åpne {{appName}}",
}

export const dict = {
  ...
  "desktop.contextMenu.saveImageAs": "画像を別名で保存...",
  "desktop.contextMenu.copyImage": "画像をコピー",
  "desktop.contextMenu.inspect": "要素を検証",
  ...
  "desktop.updater.none.message": "すでに最新バージョンの {{appName}} を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "{{appName}} のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  "desktop.updater.installFailed.title": "アップデートに失敗しました",
  "desktop.updater.installFailed.message": "アップデートをインストールできませんでした",

  "desktop.updater.progress.windowTitle": "{{appName}} をアップデート中",
  "desktop.updater.progress.preparing": "アップデートを準備中...",
  "desktop.updater.progress.downloading": "アップデートをダウンロード中...",
  "desktop.updater.progress.installing": "アップデートをインストール中...",
  "desktop.updater.progress.failed": "アップデートに失敗しました",
  "desktop.updater.progress.cancelled": "アップデートをキャンセルしました",
  "desktop.updater.progress.cancel": "キャンセル",
  "desktop.updater.progress.close": "閉じる",

  "desktop.cli.installed.title": "CLI をインストールしました",
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して '{{appName}}' コマンドを使用してください。",
  "desktop.cli.failed.title": "インストールに失敗しました",
  "desktop.cli.failed.message": "CLI のインストールに失敗しました: {{error}}",

  "desktop.tray.recent": "最近",
  "desktop.tray.more": "もっと見る",
  "desktop.tray.open": "{{appName}} を開く",
}

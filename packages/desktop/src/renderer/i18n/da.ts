export const dict = {
  ...
  "desktop.contextMenu.saveImageAs": "Gem billede som...",
  "desktop.contextMenu.copyImage": "Kopier billede",
  "desktop.contextMenu.inspect": "Inspicer element",
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af {{appName}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af {{appName}} er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.updater.progress.windowTitle": "Opdaterer {{appName}}",
  "desktop.updater.progress.preparing": "Forbereder opdatering...",
  "desktop.updater.progress.downloading": "Henter opdatering...",
  "desktop.updater.progress.installing": "Installerer opdatering...",
  "desktop.updater.progress.failed": "Opdatering mislykkedes",
  "desktop.updater.progress.cancelled": "Opdatering annulleret",
  "desktop.updater.progress.cancel": "Annuller",
  "desktop.updater.progress.close": "Luk",

  "desktop.cli.installed.title": "CLI installeret",
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge '{{appName}}'-kommandoen.",
  "desktop.cli.failed.title": "Installation mislykkedes",
  "desktop.cli.failed.message": "Kunne ikke installere CLI: {{error}}",

  "desktop.tray.recent": "Seneste",
  "desktop.tray.more": "Mere",
  "desktop.tray.open": "Åbn {{appName}}",
}

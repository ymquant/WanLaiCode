...
import { openNewSession as openNewSessionRoute } from "@/utils/new-session"
...
export const SortableWorkspace = (props: {
  ...
  const openWorkspaceNewSession = () => {
    props.ctx.clearHoverProjectSoon()
    openNewSessionRoute({ slug: slug(), reset: resetPromptDraft, navigate })
  }
          ...
          >
            <div class="flex items-center gap-1">
              ...
              <WorkspaceActions
                ...
                clearHoverProjectSoon={props.ctx.clearHoverProjectSoon}
                onNewSession={openWorkspaceNewSession}
              />
            </div>
          </div>
        </div>

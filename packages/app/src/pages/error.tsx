...
import { DialogIssueReport } from "@/components/dialog-issue-report"
    ...
    <div class="relative flex-1 h-screen w-screen min-h-0 flex flex-col items-center justify-center bg-background-base font-sans">
      <div class="w-2/3 max-w-3xl flex flex-col items-center justify-center gap-8">
        ...
        <div class="flex flex-row items-center justify-center gap-3 flex-wrap max-w-64">
          ...
          <Button
            ...
            onClick={() => {
              dialog.show(() => (
                <DialogIssueReport
                  error={props.error}
                  title={language.t("issueReport.defaultCrashTitle")}
                  description={formatError(props.error, language.t)}
                  category="crash"
                  severity="high"
                />
              ))
          ...
          >
            {language.t("error.page.action.report")}
          </Button>
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="flex items-center justify-center gap-1">
            ...
            <button
              ...
              onClick={() => platform.openLink("https://wanlai.ai/community")}
            >
              <div>{language.t("error.page.report.community")}</div>
              <Icon name="globe" class="text-text-interactive-base" />
            </button>
          </div>

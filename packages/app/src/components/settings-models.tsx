...
export const SettingsModels: Component = () => {
  ...
  const list = useFilteredList<ModelItem>({
    items: (_filter) => models.list().filter((model) => model.provider.id !== "opencode"),
    ...
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-4 pb-10 sm:px-10 sm:pb-10">
      <div class="sticky top-0 z-10 bg-[linear-gradient(to_bottom,var(--surface-stronger-non-alpha)_calc(100%_-_24px),transparent)]">
        <div class="flex flex-col gap-4 pt-6 pb-6 max-w-[720px]">
          ...
          <div class="flex items-center gap-2 max-w-[720px]">
            <div
              data-settings-drag-block
              class="flex flex-1 min-w-0 items-center gap-2 px-3 h-9 rounded-lg bg-surface-base"
            >
            ...
            <div class="flex w-7 shrink-0 items-center justify-center mr-2">
              <ModelListRefreshButton />
            </div>
          </div>
        </div>
      </div>

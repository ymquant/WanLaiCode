export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans {{appName}}.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans wanlaicode.json",
  ...
  "dialog.server.description": "Changez le serveur {{appName}} auquel cette application se connecte.",
  ...
  "context.usage.compact.hint": "Compacter",
  ...
  "toast.update.description":
    "Une nouvelle version de {{appName}} ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe {{appName}}",
  "error.page.report.community": "dans la communauté",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (wanlaicode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    'Le serveur MCP "{{name}}" a échoué. Notez que {{appName}} ne supporte pas encore l\'authentification MCP.',
  ...
  "session.header.togglePinnedSummary": "Basculer le résumé épinglé",
  ...
  "dialog.commit.field.placeholder": "Message de commit (généré automatiquement si laissé vide)",
  "dialog.createPullRequest.field.titlePlaceholder": "Titre de la PR (généré automatiquement si laissé vide)",
  "dialog.createPullRequest.field.bodyPlaceholder": "Description de la PR (générée automatiquement si laissée vide)",
  "dialog.createPullRequest.noChanges.branch": "Cette branche n'a aucune modification par rapport à la branche par défaut.",
  "dialog.commit.noChanges.stagedOnly":
    "Rien n'est staged dans la sélection actuelle. Stagez d'abord les fichiers ou activez « Inclure les modifications non staged ».",
  "dialog.commit.noChanges.all": "Il n'y a aucune modification non commitée.",
  "dialog.commit.toast.noChanges.title": "Impossible de committer",
  "dialog.gitGenerate.toast.noChanges.title": "Impossible de générer",
  "dialog.gitGenerate.action.generate": "Générer",
  "dialog.gitGenerate.action.generating": "Génération…",
  "dialog.gitGenerate.toast.failed": "Échec de la génération",
  "dialog.gitGenerate.toast.empty": "Rien n'a été généré. Vérifiez les modifications de code et un modèle configuré.",
  "dialog.gitGenerate.error.noChanges": "Aucune modification à résumer",
  "dialog.gitGenerate.error.noBranchChanges": "Aucune modification de branche à résumer",
  "dialog.gitGenerate.error.commitFailed": "Échec de la génération du message de commit",
  "dialog.gitGenerate.error.prTitleFailed": "Échec de la génération du titre de pull request",
  "dialog.gitGenerate.error.emptyResponse": "Réponse vide du modèle",
  "dialog.gitGenerate.error.generic": "Échec de la génération du contenu",
  ...
  "sidebar.gettingStarted.line1":
    "{{appName}} inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "sidebar.blankProject.title": "Nouveau projet vierge",
  "sidebar.blankProject.nameLabel": "Nom du projet",
  "sidebar.blankProject.pathLabel": "Créer dans",
  "sidebar.blankProject.browse": "Choisir un dossier",
  "sidebar.blankProject.create": "Créer",
  "sidebar.blankProject.createDisabled.path": "Saisissez un dossier de création",
  "sidebar.blankProject.createDisabled.nameRequired": "Saisissez un nom de projet",
  "sidebar.blankProject.createDisabled.nameInvalid": "Le nom contient des caractères invalides ou réservés",
  "sidebar.blankProject.error.exists": "Un projet avec ce nom existe déjà dans ce dossier",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur {{appName}} dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour {{appName}}",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence de {{appName}} sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si {{appName}} suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème de {{appName}}.",
  ...
  "settings.general.row.translateReasoning.title": "Translate reasoning summaries",
  "settings.general.row.translateReasoning.description":
    "Translate reasoning summaries that aren't in your language into your language. Each reasoning block costs extra model tokens.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement de {{appName}}",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version de {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Définir le namespace du plugin",
  "plugins.namespace.dialog.description": "Le namespace est le nom public qui relie les plugins publies a votre compte.",
  "plugins.namespace.dialog.immutable": "Une fois defini, il ne peut plus etre modifie. Choisissez donc un nom que vous souhaitez conserver.",
  "plugins.namespace.dialog.placeholder": "votre-namespace",
  "plugins.namespace.dialog.action": "Définir le namespace",
  "plugins.namespace.dialog.failed": "Impossible de définir le namespace",
  "plugins.namespace.dialog.noSpaces": "Le namespace ne peut pas contenir d'espaces.",
  "plugins.namespace.created": "namespace défini",
  "plugins.namespace.checkFailed": "Impossible de vérifier le namespace",
  "plugins.published.title": "Plugins publiés",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Non défini",
  "plugins.published.setNamespace": "Définir le namespace",
  "plugins.published.namespaceMissing": "Définissez un namespace avant de publier des plugins.",
  "plugins.published.empty": "Aucun plugin publié pour le moment.",
  "plugins.published.noVersion": "Aucune version",
  "plugins.published.downloads": "{{count}} téléchargements",
  "plugins.published.delete.action": "Supprimer le plugin",
  "plugins.published.delete.success": "Plugin supprimé",
  "plugins.published.delete.failed": "Impossible de supprimer le plugin",
  "plugins.published.delete.confirm.title": "Supprimer le plugin",
  "plugins.published.delete.confirm.description":
    "Supprimer {{name}} et toutes ses versions du registre de plugins.",

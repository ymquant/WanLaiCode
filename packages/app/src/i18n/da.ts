export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i {{appName}}.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i wanlaicode.json",
  ...
  "dialog.server.description": "Skift hvilken {{appName}}-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af {{appName}} ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til {{appName}}-teamet",
  "error.page.report.community": "i fællesskabet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (wanlaicode.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, {{appName}} understøtter ikke MCP-godkendelse endnu.',
  ...
  "session.header.togglePinnedSummary": "Skift fastgjort resumé",
  ...
  "dialog.commit.field.placeholder": "Commit-besked (genereres automatisk, hvis den efterlades tom)",
  "dialog.createPullRequest.field.titlePlaceholder": "PR-titel (genereres automatisk, hvis den efterlades tom)",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR-beskrivelse (genereres automatisk, hvis den efterlades tom)",
  "dialog.createPullRequest.noChanges.branch": "Denne branch har ingen ændringer sammenlignet med standardbranchen.",
  "dialog.commit.noChanges.stagedOnly":
    "Intet er staged i det aktuelle udvalg. Stage filer først, eller slå \"Inkluder unstaged ændringer\" til.",
  "dialog.commit.noChanges.all": "Der er ingen ucommitted ændringer.",
  "dialog.commit.toast.noChanges.title": "Kan ikke committe",
  "dialog.gitGenerate.toast.noChanges.title": "Kan ikke generere",
  "dialog.gitGenerate.action.generate": "Generér",
  "dialog.gitGenerate.action.generating": "Genererer…",
  "dialog.gitGenerate.toast.failed": "Generering mislykkedes",
  "dialog.gitGenerate.toast.empty": "Intet blev genereret. Tjek for kodeændringer og en konfigureret model.",
  "dialog.gitGenerate.error.noChanges": "Ingen ændringer at opsummere",
  "dialog.gitGenerate.error.noBranchChanges": "Ingen branch-ændringer at opsummere",
  "dialog.gitGenerate.error.commitFailed": "Kunne ikke generere commit-besked",
  "dialog.gitGenerate.error.prTitleFailed": "Kunne ikke generere PR-titel",
  "dialog.gitGenerate.error.emptyResponse": "Tom modelsvar",
  "dialog.gitGenerate.error.generic": "Kunne ikke generere indhold",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "sidebar.blankProject.title": "Nyt tomt projekt",
  "sidebar.blankProject.nameLabel": "Projektnavn",
  "sidebar.blankProject.pathLabel": "Opret i",
  "sidebar.blankProject.browse": "Vælg mappe",
  "sidebar.blankProject.create": "Opret",
  "sidebar.blankProject.createDisabled.path": "Angiv en mappe til projektet",
  "sidebar.blankProject.createDisabled.nameRequired": "Angiv et projektnavn",
  "sidebar.blankProject.createDisabled.nameInvalid": "Projektnavnet indeholder ugyldige eller reserverede tegn",
  "sidebar.blankProject.error.exists": "Der findes allerede et projekt med dette navn i mappen",
  ...
  "settings.desktop.wsl.description": "Kør {{appName}}-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for {{appName}}",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan {{appName}} ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om {{appName}} følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan {{appName}} er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når {{appName}} starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Angiv plugin-namespace",
  "plugins.namespace.dialog.description": "namespace er det offentlige navn, der knytter udgivne plugins til din konto.",
  "plugins.namespace.dialog.immutable": "Når det er angivet, kan det ikke ændres, så vælg et navn du vil beholde.",
  "plugins.namespace.dialog.placeholder": "dit-namespace",
  "plugins.namespace.dialog.action": "Angiv namespace",
  "plugins.namespace.dialog.failed": "Kunne ikke angive namespace",
  "plugins.namespace.dialog.noSpaces": "namespace må ikke indeholde mellemrum.",
  "plugins.namespace.created": "namespace angivet",
  "plugins.namespace.checkFailed": "Kunne ikke kontrollere namespace",
  "plugins.published.title": "Udgivne plugins",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Ikke angivet",
  "plugins.published.setNamespace": "Angiv namespace",
  "plugins.published.namespaceMissing": "Angiv et namespace, før du udgiver plugins.",
  "plugins.published.empty": "Ingen udgivne plugins endnu.",
  "plugins.published.noVersion": "Ingen version",
  "plugins.published.downloads": "{{count}} downloads",
  "plugins.published.delete.action": "Slet plugin",
  "plugins.published.delete.success": "Plugin slettet",
  "plugins.published.delete.failed": "Kunne ikke slette plugin",
  "plugins.published.delete.confirm.title": "Slet plugin",
  "plugins.published.delete.confirm.description":
    "Slet {{name}} og alle versioner fra plugin-registry.",

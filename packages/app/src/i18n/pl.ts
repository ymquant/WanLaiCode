export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w {{appName}}.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w wanlaicode.json",
  ...
  "dialog.server.description": "Przełącz serwer {{appName}}, z którym łączy się ta aplikacja.",
  ...
  "context.usage.compact.hint": "Kompaktuj",
  ...
  "toast.update.description": "Nowa wersja {{appName}} ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu {{appName}}",
  "error.page.report.community": "w społeczności",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (wanlaicode.json) nazwy dostawców/modeli",
  ...
  "session.header.togglePinnedSummary": "Przełącz przypięte podsumowanie",
  ...
  "dialog.commit.field.placeholder": "Wiadomość commita (generowana automatycznie, jeśli pozostawisz puste)",
  "dialog.createPullRequest.field.titlePlaceholder": "Tytuł PR (generowany automatycznie, jeśli pozostawisz pusty)",
  "dialog.createPullRequest.field.bodyPlaceholder": "Opis PR (generowany automatycznie, jeśli pozostawisz pusty)",
  "dialog.createPullRequest.noChanges.branch": "Ten branch nie ma zmian w porównaniu z domyślnym branchem.",
  "dialog.commit.noChanges.stagedOnly":
    "Nic nie jest staged w bieżącym zakresie. Najpierw dodaj pliki do stage lub włącz „Uwzględnij zmiany unstaged”.",
  "dialog.commit.noChanges.all": "Brak niezacommitowanych zmian.",
  "dialog.commit.toast.noChanges.title": "Nie można commitować",
  "dialog.gitGenerate.toast.noChanges.title": "Nie można wygenerować",
  "dialog.gitGenerate.action.generate": "Generuj",
  "dialog.gitGenerate.action.generating": "Generowanie…",
  "dialog.gitGenerate.toast.failed": "Generowanie nie powiodło się",
  "dialog.gitGenerate.toast.empty": "Nic nie wygenerowano. Sprawdź zmiany w kodzie i skonfigurowany model.",
  "dialog.gitGenerate.error.noChanges": "Brak zmian do podsumowania",
  "dialog.gitGenerate.error.noBranchChanges": "Brak zmian w gałęzi do podsumowania",
  "dialog.gitGenerate.error.commitFailed": "Nie udało się wygenerować wiadomości commita",
  "dialog.gitGenerate.error.prTitleFailed": "Nie udało się wygenerować tytułu PR",
  "dialog.gitGenerate.error.emptyResponse": "Pusta odpowiedź modelu",
  "dialog.gitGenerate.error.generic": "Nie udało się wygenerować treści",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "sidebar.blankProject.title": "Nowy pusty projekt",
  "sidebar.blankProject.nameLabel": "Nazwa projektu",
  "sidebar.blankProject.pathLabel": "Utwórz w",
  "sidebar.blankProject.browse": "Wybierz folder",
  "sidebar.blankProject.create": "Utwórz",
  "sidebar.blankProject.createDisabled.path": "Podaj folder do utworzenia projektu",
  "sidebar.blankProject.createDisabled.nameRequired": "Podaj nazwę projektu",
  "sidebar.blankProject.createDisabled.nameInvalid": "Nazwa zawiera nieprawidłowe lub zarezerwowane znaki",
  "sidebar.blankProject.error.exists": "Projekt o tej nazwie już istnieje w tym folderze",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla {{appName}}",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd {{appName}} na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy {{appName}} ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw {{appName}}.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania {{appName}}",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Ustaw namespace pluginu",
  "plugins.namespace.dialog.description": "namespace to publiczna nazwa laczaca opublikowane pluginy z Twoim kontem.",
  "plugins.namespace.dialog.immutable": "Po ustawieniu nie mozna go zmienic, wiec wybierz nazwe, ktora chcesz zachowac.",
  "plugins.namespace.dialog.placeholder": "twoj-namespace",
  "plugins.namespace.dialog.action": "Ustaw namespace",
  "plugins.namespace.dialog.failed": "Nie udało się ustawić namespace",
  "plugins.namespace.dialog.noSpaces": "namespace nie może zawierać spacji.",
  "plugins.namespace.created": "namespace ustawiony",
  "plugins.namespace.checkFailed": "Nie udało się sprawdzić namespace",
  "plugins.published.title": "Opublikowane pluginy",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Nie ustawiono",
  "plugins.published.setNamespace": "Ustaw namespace",
  "plugins.published.namespaceMissing": "Ustaw namespace przed publikowaniem pluginów.",
  "plugins.published.empty": "Nie ma jeszcze opublikowanych pluginów.",
  "plugins.published.noVersion": "Brak wersji",
  "plugins.published.downloads": "{{count}} pobrań",
  "plugins.published.delete.action": "Usuń plugin",
  "plugins.published.delete.success": "Plugin usunięty",
  "plugins.published.delete.failed": "Nie udało się usunąć pluginu",
  "plugins.published.delete.confirm.title": "Usuń plugin",
  "plugins.published.delete.confirm.description":
    "Usuń {{name}} i wszystkie jego wersje z registry pluginów.",

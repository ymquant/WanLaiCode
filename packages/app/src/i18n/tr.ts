...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve {{appName}}'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve {{appName}}'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak {{appName}}'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler wanlaicode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi {{appName}} sunucusuna bağlanacağını değiştirin.",
  ...
  "context.usage.compact.hint": "Sıkıştır",
  ...
  "toast.update.description": "{{appName}}'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı {{appName}} ekibine bildirin",
  "error.page.report.community": "toplulukta",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (wanlaicode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: {{appName}} henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "session.header.togglePinnedSummary": "Sabitlenmiş özeti aç/kapat",
  ...
  "dialog.commit.field.placeholder": "Commit mesajı (boş bırakılırsa otomatik oluşturulur)",
  "dialog.createPullRequest.field.titlePlaceholder": "PR başlığı (boş bırakılırsa otomatik oluşturulur)",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR açıklaması (boş bırakılırsa otomatik oluşturulur)",
  "dialog.createPullRequest.noChanges.branch": "Bu dal, varsayılan dala göre değişiklik içermiyor.",
  "dialog.commit.noChanges.stagedOnly":
    "Mevcut kapsamda staged değişiklik yok. Önce dosyaları stage edin veya \"Unstaged değişiklikleri dahil et\"i açın.",
  "dialog.commit.noChanges.all": "Commit edilmemiş değişiklik yok.",
  "dialog.commit.toast.noChanges.title": "Commit yapılamıyor",
  "dialog.gitGenerate.toast.noChanges.title": "Oluşturulamıyor",
  "dialog.gitGenerate.action.generate": "Oluştur",
  "dialog.gitGenerate.action.generating": "Oluşturuluyor…",
  "dialog.gitGenerate.toast.failed": "Oluşturma başarısız",
  "dialog.gitGenerate.toast.empty": "İçerik oluşturulmadı. Kod değişikliklerini ve yapılandırılmış bir modeli kontrol edin.",
  "dialog.gitGenerate.error.noChanges": "Özetlenecek değişiklik yok",
  "dialog.gitGenerate.error.noBranchChanges": "Özetlenecek dal değişikliği yok",
  "dialog.gitGenerate.error.commitFailed": "Commit mesajı oluşturulamadı",
  "dialog.gitGenerate.error.prTitleFailed": "PR başlığı oluşturulamadı",
  "dialog.gitGenerate.error.emptyResponse": "Boş model yanıtı",
  "dialog.gitGenerate.error.generic": "İçerik oluşturulamadı",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "sidebar.blankProject.title": "Yeni boş proje",
  "sidebar.blankProject.nameLabel": "Proje adı",
  "sidebar.blankProject.pathLabel": "Oluşturma konumu",
  "sidebar.blankProject.browse": "Klasör seç",
  "sidebar.blankProject.create": "Oluştur",
  "sidebar.blankProject.createDisabled.path": "Proje için bir klasör girin",
  "sidebar.blankProject.createDisabled.nameRequired": "Proje adı girin",
  "sidebar.blankProject.createDisabled.nameInvalid": "Proje adı geçersiz veya ayrılmış karakterler içeriyor",
  "sidebar.blankProject.error.exists": "Bu klasörde aynı adlı bir proje zaten var",

  "app.name.desktop": "{{appName}} Masaüstü",
  ...
  "settings.desktop.wsl.description": "{{appName}} sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "{{appName}}'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "{{appName}}'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "{{appName}}'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "{{appName}}'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "{{appName}} başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "{{appName}}'un en son sürümünü kullanıyorsunuz.",
  ...
  "plugins.namespace.dialog.title": "Plugin namespace ayarla",
  "plugins.namespace.dialog.description": "namespace, yayinlanan pluginleri hesabina baglayan herkese acik addir.",
  "plugins.namespace.dialog.immutable": "Ayarladiktan sonra degistirilemez; bu yuzden korumak istedigin bir ad sec.",
  "plugins.namespace.dialog.placeholder": "namespace-in",
  "plugins.namespace.dialog.action": "namespace ayarla",
  "plugins.namespace.dialog.failed": "namespace ayarlanamadı",
  "plugins.namespace.dialog.noSpaces": "namespace boşluk içeremez.",
  "plugins.namespace.created": "namespace ayarlandı",
  "plugins.namespace.checkFailed": "namespace kontrol edilemedi",
  "plugins.published.title": "Yayınlanan pluginler",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Ayarlanmadı",
  "plugins.published.setNamespace": "namespace ayarla",
  "plugins.published.namespaceMissing": "Plugin yayınlamadan önce bir namespace ayarlayın.",
  "plugins.published.empty": "Henüz yayınlanmış plugin yok.",
  "plugins.published.noVersion": "Sürüm yok",
  "plugins.published.downloads": "{{count}} indirme",
  "plugins.published.delete.action": "Plugini sil",
  "plugins.published.delete.success": "Plugin silindi",
  "plugins.published.delete.failed": "Plugin silinemedi",
  "plugins.published.delete.confirm.title": "Plugini sil",
  "plugins.published.delete.confirm.description":
    "{{name}} ve tüm sürümlerini plugin registry'den sil.",

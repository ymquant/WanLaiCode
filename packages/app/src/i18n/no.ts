...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i {{appName}}.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i wanlaicode.json",
  ...
  "dialog.server.description": "Bytt hvilken {{appName}}-server denne appen kobler til.",
  ...
  "context.usage.compact.hint": "Komprimér",
  ...
  "toast.update.description": "En ny versjon av {{appName}} ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til {{appName}}-teamet",
  "error.page.report.community": "i fellesskapet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (wanlaicode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at {{appName}} ikke støtter MCP-autentisering ennå.',
  ...
  "session.header.togglePinnedSummary": "Bytt festet sammendrag",
  ...
  "dialog.commit.field.placeholder": "Commit-melding (genereres automatisk hvis den står tom)",
  "dialog.createPullRequest.field.titlePlaceholder": "PR-tittel (genereres automatisk hvis den står tom)",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR-beskrivelse (genereres automatisk hvis den står tom)",
  "dialog.createPullRequest.noChanges.branch": "Denne branchen har ingen endringer sammenlignet med standardbranchen.",
  "dialog.commit.noChanges.stagedOnly":
    "Ingenting er staged i det aktuelle utvalget. Stage filer først, eller slå på «Inkluder unstaged endringer».",
  "dialog.commit.noChanges.all": "Det finnes ingen ucommittede endringer.",
  "dialog.commit.toast.noChanges.title": "Kan ikke committe",
  "dialog.gitGenerate.toast.noChanges.title": "Kan ikke generere",
  "dialog.gitGenerate.action.generate": "Generer",
  "dialog.gitGenerate.action.generating": "Genererer…",
  "dialog.gitGenerate.toast.failed": "Generering mislyktes",
  "dialog.gitGenerate.toast.empty": "Ingenting ble generert. Sjekk kodeendringer og en konfigurert modell.",
  "dialog.gitGenerate.error.noChanges": "Ingen endringer å oppsummere",
  "dialog.gitGenerate.error.noBranchChanges": "Ingen branch-endringer å oppsummere",
  "dialog.gitGenerate.error.commitFailed": "Kunne ikke generere commit-melding",
  "dialog.gitGenerate.error.prTitleFailed": "Kunne ikke generere PR-tittel",
  "dialog.gitGenerate.error.emptyResponse": "Tom modellrespons",
  "dialog.gitGenerate.error.generic": "Kunne ikke generere innhold",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "sidebar.blankProject.title": "Nytt tomt prosjekt",
  "sidebar.blankProject.nameLabel": "Prosjektnavn",
  "sidebar.blankProject.pathLabel": "Opprett i",
  "sidebar.blankProject.browse": "Velg mappe",
  "sidebar.blankProject.create": "Opprett",
  "sidebar.blankProject.createDisabled.path": "Angi en mappe for prosjektet",
  "sidebar.blankProject.createDisabled.nameRequired": "Angi et prosjektnavn",
  "sidebar.blankProject.createDisabled.nameInvalid": "Prosjektnavnet inneholder ugyldige eller reserverte tegn",
  "sidebar.blankProject.error.exists": "Et prosjekt med dette navnet finnes allerede i mappen",
  ...
  "settings.desktop.wsl.description": "Kjør {{appName}}-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for {{appName}}",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan {{appName}} ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om {{appName}} skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan {{appName}} er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når {{appName}} starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Angi plugin-namespace",
  "plugins.namespace.dialog.description": "namespace er det offentlige navnet som knytter publiserte plugins til kontoen din.",
  "plugins.namespace.dialog.immutable": "Nar det er angitt, kan det ikke endres, sa velg et navn du vil beholde.",
  "plugins.namespace.dialog.placeholder": "ditt-namespace",
  "plugins.namespace.dialog.action": "Angi namespace",
  "plugins.namespace.dialog.failed": "Kunne ikke angi namespace",
  "plugins.namespace.dialog.noSpaces": "namespace kan ikke inneholde mellomrom.",
  "plugins.namespace.created": "namespace angitt",
  "plugins.namespace.checkFailed": "Kunne ikke sjekke namespace",
  "plugins.published.title": "Publiserte plugins",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Ikke angitt",
  "plugins.published.setNamespace": "Angi namespace",
  "plugins.published.namespaceMissing": "Angi et namespace før du publiserer plugins.",
  "plugins.published.empty": "Ingen publiserte plugins ennå.",
  "plugins.published.noVersion": "Ingen versjon",
  "plugins.published.downloads": "{{count}} nedlastinger",
  "plugins.published.delete.action": "Slett plugin",
  "plugins.published.delete.success": "Plugin slettet",
  "plugins.published.delete.failed": "Kunne ikke slette plugin",
  "plugins.published.delete.confirm.title": "Slett plugin",
  "plugins.published.delete.confirm.description":
    "Slett {{name}} og alle versjoner fra plugin-registry.",

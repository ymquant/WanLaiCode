export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в {{appName}}.",
  ...
  "dialog.plugins.empty": "Плагины настроены в wanlaicode.json",
  ...
  "dialog.server.description": "Переключите сервер {{appName}} к которому подключается приложение.",
  ...
  "context.usage.compact.hint": "Сжать",
  ...
  "toast.update.description": "Новая версия {{appName}} ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде {{appName}}",
  "error.page.report.community": "в сообществе",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (wanlaicode.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что {{appName}} пока не поддерживает MCP авторизацию.',
  ...
  "session.header.togglePinnedSummary": "Переключить закреплённую сводку",
  ...
  "dialog.commit.field.placeholder": "Сообщение коммита (будет сгенерировано автоматически, если оставить пустым)",
  "dialog.createPullRequest.field.titlePlaceholder": "Заголовок PR (будет сгенерирован автоматически, если оставить пустым)",
  "dialog.createPullRequest.field.bodyPlaceholder": "Описание PR (будет сгенерировано автоматически, если оставить пустым)",
  "dialog.createPullRequest.noChanges.branch": "В этой ветке нет изменений относительно ветки по умолчанию.",
  "dialog.commit.noChanges.stagedOnly":
    "В текущем выборе нет staged-изменений. Сначала добавьте файлы в stage или включите «Включить unstaged изменения».",
  "dialog.commit.noChanges.all": "Нет незакоммиченных изменений.",
  "dialog.commit.toast.noChanges.title": "Невозможно закоммитить",
  "dialog.gitGenerate.toast.noChanges.title": "Невозможно сгенерировать",
  "dialog.gitGenerate.action.generate": "Сгенерировать",
  "dialog.gitGenerate.action.generating": "Генерация…",
  "dialog.gitGenerate.toast.failed": "Не удалось сгенерировать",
  "dialog.gitGenerate.toast.empty": "Ничего не сгенерировано. Проверьте изменения кода и настроенную модель.",
  "dialog.gitGenerate.error.noChanges": "Нет изменений для резюмирования",
  "dialog.gitGenerate.error.noBranchChanges": "Нет изменений в ветке для резюмирования",
  "dialog.gitGenerate.error.commitFailed": "Не удалось сгенерировать сообщение коммита",
  "dialog.gitGenerate.error.prTitleFailed": "Не удалось сгенерировать заголовок PR",
  "dialog.gitGenerate.error.emptyResponse": "Пустой ответ модели",
  "dialog.gitGenerate.error.generic": "Не удалось сгенерировать контент",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "sidebar.blankProject.title": "Новый пустой проект",
  "sidebar.blankProject.nameLabel": "Имя проекта",
  "sidebar.blankProject.pathLabel": "Создать в",
  "sidebar.blankProject.browse": "Выбрать папку",
  "sidebar.blankProject.create": "Создать",
  "sidebar.blankProject.createDisabled.path": "Укажите папку для создания проекта",
  "sidebar.blankProject.createDisabled.nameRequired": "Введите имя проекта",
  "sidebar.blankProject.createDisabled.nameInvalid": "Имя содержит недопустимые или зарезервированные символы",
  "sidebar.blankProject.error.exists": "Проект с таким именем уже существует в этой папке",
  ...
  "settings.desktop.wsl.description": "Запускать сервер {{appName}} внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения {{appName}}",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как {{appName}} выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли {{appName}} системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление {{appName}}.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске {{appName}}",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Задать namespace плагина",
  "plugins.namespace.dialog.description": "namespace - это публичное имя, которое связывает опубликованные плагины с вашей учетной записью.",
  "plugins.namespace.dialog.immutable": "После настройки его нельзя изменить, поэтому выберите имя, которое хотите сохранить.",
  "plugins.namespace.dialog.placeholder": "your-namespace",
  "plugins.namespace.dialog.action": "Задать namespace",
  "plugins.namespace.dialog.failed": "Не удалось задать namespace",
  "plugins.namespace.dialog.noSpaces": "namespace не может содержать пробелы.",
  "plugins.namespace.created": "namespace задан",
  "plugins.namespace.checkFailed": "Не удалось проверить namespace",
  "plugins.published.title": "Опубликованные плагины",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Не задан",
  "plugins.published.setNamespace": "Задать namespace",
  "plugins.published.namespaceMissing": "Задайте namespace перед публикацией плагинов.",
  "plugins.published.empty": "Опубликованных плагинов пока нет.",
  "plugins.published.noVersion": "Нет версии",
  "plugins.published.downloads": "{{count}} загрузок",
  "plugins.published.delete.action": "Удалить плагин",
  "plugins.published.delete.success": "Плагин удален",
  "plugins.published.delete.failed": "Не удалось удалить плагин",
  "plugins.published.delete.confirm.title": "Удалить плагин",
  "plugins.published.delete.confirm.description":
    "Удалить {{name}} и все его версии из registry плагинов.",

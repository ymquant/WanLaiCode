export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u {{appName}}-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u {{appName}}-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u {{appName}}-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u wanlaicode.json",
  ...
  "dialog.server.description": "Promijeni na koji se {{appName}} server ova aplikacija povezuje.",
  ...
  "context.usage.compact.hint": "Sažmi",
  ...
  "toast.update.description": "Nova verzija {{appName}}-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku {{appName}} timu",
  "error.page.report.community": "u zajednici",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (wanlaicode.json) provider/model names",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: {{appName}} još ne podržava MCP autentifikaciju.',
  ...
  "session.header.togglePinnedSummary": "Prebaci zakačeni sažetak",
  ...
  "dialog.commit.field.placeholder": "Poruka commit-a (automatski generisana ako ostane prazna)",
  "dialog.createPullRequest.field.titlePlaceholder": "PR naslov (automatski generisan ako ostane prazan)",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR opis (automatski generisan ako ostane prazan)",
  "dialog.createPullRequest.noChanges.branch": "Ova grana nema promjena u odnosu na zadanu granu.",
  "dialog.commit.noChanges.stagedOnly":
    "Ništa nije staged u trenutnom opsegu. Prvo stage-ajte datoteke ili uključite „Uključi unstaged promjene“.",
  "dialog.commit.noChanges.all": "Nema uncommitted promjena.",
  "dialog.commit.toast.noChanges.title": "Commit nije moguć",
  "dialog.gitGenerate.toast.noChanges.title": "Generisanje nije moguće",
  "dialog.gitGenerate.action.generate": "Generiši",
  "dialog.gitGenerate.action.generating": "Generisanje…",
  "dialog.gitGenerate.toast.failed": "Generisanje nije uspjelo",
  "dialog.gitGenerate.toast.empty": "Ništa nije generisano. Provjerite promjene koda i konfigurirani model.",
  "dialog.gitGenerate.error.noChanges": "Nema promjena za sažetak",
  "dialog.gitGenerate.error.noBranchChanges": "Nema promjena grane za sažetak",
  "dialog.gitGenerate.error.commitFailed": "Generisanje commit poruke nije uspjelo",
  "dialog.gitGenerate.error.prTitleFailed": "Generisanje PR naslova nije uspjelo",
  "dialog.gitGenerate.error.emptyResponse": "Prazan odgovor modela",
  "dialog.gitGenerate.error.generic": "Generisanje sadržaja nije uspjelo",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "sidebar.blankProject.title": "Nov prazan projekat",
  "sidebar.blankProject.nameLabel": "Naziv projekta",
  "sidebar.blankProject.pathLabel": "Kreiraj u",
  "sidebar.blankProject.browse": "Odaberi folder",
  "sidebar.blankProject.create": "Kreiraj",
  "sidebar.blankProject.createDisabled.path": "Unesite folder za kreiranje projekta",
  "sidebar.blankProject.createDisabled.nameRequired": "Unesite naziv projekta",
  "sidebar.blankProject.createDisabled.nameInvalid": "Naziv sadrži nevažeće ili rezervisane znakove",
  "sidebar.blankProject.error.exists": "Projekt s ovim nazivom već postoji u tom folderu",
  ...
  "settings.desktop.wsl.description": "Pokreni {{appName}} server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u {{appName}}-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako {{appName}} izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li {{appName}} prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu {{appName}}-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se {{appName}} pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju {{appName}}-a.",
  ...
  "plugins.namespace.dialog.title": "Postavi namespace plugina",
  "plugins.namespace.dialog.description": "namespace je javno ime koje povezuje objavljene plugine s tvojim racunom.",
  "plugins.namespace.dialog.immutable": "Nakon postavljanja ne moze se mijenjati, zato odaberi ime koje zelis zadrzati.",
  "plugins.namespace.dialog.placeholder": "tvoj-namespace",
  "plugins.namespace.dialog.action": "Postavi namespace",
  "plugins.namespace.dialog.failed": "Nije uspjelo postavljanje namespacea",
  "plugins.namespace.dialog.noSpaces": "namespace ne može sadržavati razmake.",
  "plugins.namespace.created": "namespace postavljen",
  "plugins.namespace.checkFailed": "Nije uspjela provjera namespacea",
  "plugins.published.title": "Objavljeni plugini",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Nije postavljeno",
  "plugins.published.setNamespace": "Postavi namespace",
  "plugins.published.namespaceMissing": "Postavi namespace prije objavljivanja plugina.",
  "plugins.published.empty": "Još nema objavljenih plugina.",
  "plugins.published.noVersion": "Nema verzije",
  "plugins.published.downloads": "{{count}} preuzimanja",
  "plugins.published.delete.action": "Izbriši plugin",
  "plugins.published.delete.success": "Plugin izbrisan",
  "plugins.published.delete.failed": "Nije uspjelo brisanje plugina",
  "plugins.published.delete.confirm.title": "Izbriši plugin",
  "plugins.published.delete.confirm.description":
    "Izbriši {{name}} i sve njegove verzije iz registryja plugina.",

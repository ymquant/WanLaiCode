export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en {{appName}}.",
  ...
  "dialog.plugins.empty": "Plugins configurados en wanlaicode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de {{appName}} se conecta esta app.",
  ...
  "context.usage.compact.hint": "Compactar",
  ...
  "toast.update.description": "Una nueva versión de {{appName}} ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de {{appName}}",
  "error.page.report.community": "en la comunidad",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (wanlaicode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, {{appName}} no soporta autenticación MCP todavía.',
  ...
  "session.header.togglePinnedSummary": "Alternar resumen fijado",
  ...
  "dialog.commit.field.placeholder": "Mensaje de commit (se genera automáticamente si se deja vacío)",
  "dialog.createPullRequest.field.titlePlaceholder": "Título del PR (se genera automáticamente si se deja vacío)",
  "dialog.createPullRequest.field.bodyPlaceholder": "Descripción del PR (se genera automáticamente si se deja vacío)",
  "dialog.createPullRequest.noChanges.branch": "Esta rama no tiene cambios respecto a la rama predeterminada.",
  "dialog.commit.noChanges.stagedOnly":
    "No hay nada en stage en la selección actual. Haz stage de los archivos o activa \"Incluir cambios sin stage\".",
  "dialog.commit.noChanges.all": "No hay cambios sin commit.",
  "dialog.commit.toast.noChanges.title": "No se puede hacer commit",
  "dialog.gitGenerate.toast.noChanges.title": "No se puede generar",
  "dialog.gitGenerate.action.generate": "Generar",
  "dialog.gitGenerate.action.generating": "Generando…",
  "dialog.gitGenerate.toast.failed": "Error al generar",
  "dialog.gitGenerate.toast.empty": "No se generó nada. Comprueba los cambios de código y un modelo configurado.",
  "dialog.gitGenerate.error.noChanges": "No hay cambios para resumir",
  "dialog.gitGenerate.error.noBranchChanges": "No hay cambios de rama para resumir",
  "dialog.gitGenerate.error.commitFailed": "No se pudo generar el mensaje de commit",
  "dialog.gitGenerate.error.prTitleFailed": "No se pudo generar el título del pull request",
  "dialog.gitGenerate.error.emptyResponse": "Respuesta vacía del modelo",
  "dialog.gitGenerate.error.generic": "No se pudo generar el contenido",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "sidebar.blankProject.title": "Nuevo proyecto en blanco",
  "sidebar.blankProject.nameLabel": "Nombre del proyecto",
  "sidebar.blankProject.pathLabel": "Crear en",
  "sidebar.blankProject.browse": "Elegir carpeta",
  "sidebar.blankProject.create": "Crear",
  "sidebar.blankProject.createDisabled.path": "Introduce una carpeta para crear el proyecto",
  "sidebar.blankProject.createDisabled.nameRequired": "Introduce un nombre de proyecto",
  "sidebar.blankProject.createDisabled.nameInvalid": "El nombre contiene caracteres no válidos o reservados",
  "sidebar.blankProject.error.exists": "Ya existe un proyecto con este nombre en esa carpeta",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor {{appName}} dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para {{appName}}",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve {{appName}} en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si {{appName}} sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de {{appName}}.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia {{appName}}",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Configurar namespace del plugin",
  "plugins.namespace.dialog.description": "El namespace es el nombre publico que vincula los plugins publicados con tu cuenta.",
  "plugins.namespace.dialog.immutable": "Una vez configurado no se puede cambiar, asi que elige un nombre que quieras conservar.",
  "plugins.namespace.dialog.placeholder": "tu-namespace",
  "plugins.namespace.dialog.action": "Configurar namespace",
  "plugins.namespace.dialog.failed": "No se pudo configurar el namespace",
  "plugins.namespace.dialog.noSpaces": "El namespace no puede contener espacios.",
  "plugins.namespace.created": "namespace configurado",
  "plugins.namespace.checkFailed": "No se pudo comprobar el namespace",
  "plugins.published.title": "Plugins publicados",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Sin configurar",
  "plugins.published.setNamespace": "Configurar namespace",
  "plugins.published.namespaceMissing": "Configura un namespace antes de publicar plugins.",
  "plugins.published.empty": "Aún no hay plugins publicados.",
  "plugins.published.noVersion": "Sin versión",
  "plugins.published.downloads": "{{count}} descargas",
  "plugins.published.delete.action": "Eliminar plugin",
  "plugins.published.delete.success": "Plugin eliminado",
  "plugins.published.delete.failed": "No se pudo eliminar el plugin",
  "plugins.published.delete.confirm.title": "Eliminar plugin",
  "plugins.published.delete.confirm.description":
    "Eliminar {{name}} y todas sus versiones del registro de plugins.",

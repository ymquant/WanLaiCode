export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、{{appName}}で{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続して{{appName}}で{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、{{appName}}で{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "wanlaicode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続する{{appName}}サーバーを切り替えます。",
  ...
  "toast.update.description": "{{appName}}の新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーを{{appName}}チームに報告してください: ",
  "error.page.report.community": "コミュニティ",
  ...
  "error.chain.checkConfig": "config (wanlaicode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: {{appName}}はまだMCP認証をサポートしていません。',
  ...
  "session.header.togglePinnedSummary": "ピン留めサマリーを切り替え",
  ...
  "dialog.commit.field.placeholder": "コミットメッセージ（空欄の場合は自動生成）",
  "dialog.createPullRequest.field.titlePlaceholder": "PR タイトル（空欄の場合は自動生成）",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR 説明（空欄の場合は自動生成）",
  "dialog.createPullRequest.noChanges.branch": "このブランチにはデフォルトブランチとの差分がありません。",
  "dialog.commit.noChanges.stagedOnly":
    "現在の範囲に staged の変更がありません。ファイルを stage するか、「未 stage の変更を含める」をオンにしてください。",
  "dialog.commit.noChanges.all": "未コミットの変更がありません。",
  "dialog.commit.toast.noChanges.title": "コミットできません",
  "dialog.gitGenerate.toast.noChanges.title": "生成できません",
  "dialog.gitGenerate.action.generate": "生成",
  "dialog.gitGenerate.action.generating": "生成中…",
  "dialog.gitGenerate.toast.failed": "生成に失敗しました",
  "dialog.gitGenerate.toast.empty": "生成できませんでした。コード変更とモデル設定を確認してください。",
  "dialog.gitGenerate.error.noChanges": "要約する変更がありません",
  "dialog.gitGenerate.error.noBranchChanges": "要約するブランチ変更がありません",
  "dialog.gitGenerate.error.commitFailed": "コミットメッセージの生成に失敗しました",
  "dialog.gitGenerate.error.prTitleFailed": "PR タイトルの生成に失敗しました",
  "dialog.gitGenerate.error.emptyResponse": "モデルの応答が空です",
  "dialog.gitGenerate.error.generic": "コンテンツの生成に失敗しました",
  ...
  "sidebar.gettingStarted.line1": "{{appName}}には無料モデルが含まれているため、すぐに開始できます。",
  ...
  "sidebar.blankProject.title": "新規空白プロジェクト",
  "sidebar.blankProject.nameLabel": "プロジェクト名",
  "sidebar.blankProject.pathLabel": "作成場所",
  "sidebar.blankProject.browse": "フォルダを選択",
  "sidebar.blankProject.create": "作成",
  "sidebar.blankProject.createDisabled.path": "作成場所を入力してください",
  "sidebar.blankProject.createDisabled.nameRequired": "プロジェクト名を入力してください",
  "sidebar.blankProject.createDisabled.nameInvalid": "プロジェクト名に無効または予約済みの文字が含まれています",
  "sidebar.blankProject.error.exists": "この場所に同名のプロジェクトが既に存在します",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境で{{appName}}サーバーを実行します。",
  ...
  "settings.general.row.language.description": "{{appName}}の表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでの{{appName}}の表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description":
    "{{appName}}がシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "{{appName}}のテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "{{appName}} の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "{{appName}} は最新バージョンです。",
  ...
  "plugins.namespace.dialog.title": "プラグイン namespace を設定",
  "plugins.namespace.dialog.description": "namespace は、公開したプラグインをアカウントに紐づける公開名です。",
  "plugins.namespace.dialog.immutable": "設定後は変更できないため、長く使いたい名前を選んでください。",
  "plugins.namespace.dialog.placeholder": "your-namespace",
  "plugins.namespace.dialog.action": "namespace を設定",
  "plugins.namespace.dialog.failed": "namespace の設定に失敗しました",
  "plugins.namespace.dialog.noSpaces": "namespace にスペースは使用できません。",
  "plugins.namespace.created": "namespace を設定しました",
  "plugins.namespace.checkFailed": "namespace の確認に失敗しました",
  "plugins.published.title": "公開済みプラグイン",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "未設定",
  "plugins.published.setNamespace": "namespace を設定",
  "plugins.published.namespaceMissing": "プラグインを公開する前に namespace を設定してください。",
  "plugins.published.empty": "公開済みプラグインはまだありません。",
  "plugins.published.noVersion": "バージョンなし",
  "plugins.published.downloads": "{{count}} ダウンロード",
  "plugins.published.delete.action": "プラグインを削除",
  "plugins.published.delete.success": "プラグインを削除しました",
  "plugins.published.delete.failed": "プラグインの削除に失敗しました",
  "plugins.published.delete.confirm.title": "プラグインを削除",
  "plugins.published.delete.confirm.description":
    "{{name}} とすべてのバージョンをプラグイン registry から削除します。",

export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 {{appName}}에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 {{appName}}에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 {{appName}}에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "wanlaicode.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 {{appName}} 서버를 전환합니다.",
  ...
  "toast.update.description": "{{appName}}의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 {{appName}} 팀에 제보해 주세요: ",
  "error.page.report.community": "커뮤니티",
  ...
  "error.chain.checkConfig": "구성(wanlaicode.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: {{appName}}는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "session.header.togglePinnedSummary": "고정 요약 전환",
  ...
  "dialog.commit.field.placeholder": "커밋 메시지(비워 두면 자동 생성)",
  "dialog.createPullRequest.field.titlePlaceholder": "PR 제목(비워 두면 자동 생성)",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR 설명(비워 두면 자동 생성)",
  "dialog.createPullRequest.noChanges.branch": "이 브랜치에는 기본 브랜치와 비교할 변경 사항이 없습니다.",
  "dialog.commit.noChanges.stagedOnly":
    "현재 범위에 staged 변경이 없습니다. 파일을 stage하거나 \"unstaged 변경 포함\"을 켜세요.",
  "dialog.commit.noChanges.all": "커밋되지 않은 변경 사항이 없습니다.",
  "dialog.commit.toast.noChanges.title": "커밋할 수 없음",
  "dialog.gitGenerate.toast.noChanges.title": "생성할 수 없음",
  "dialog.gitGenerate.action.generate": "생성",
  "dialog.gitGenerate.action.generating": "생성 중…",
  "dialog.gitGenerate.toast.failed": "생성 실패",
  "dialog.gitGenerate.toast.empty": "생성된 내용이 없습니다. 코드 변경과 구성된 모델을 확인하세요.",
  "dialog.gitGenerate.error.noChanges": "요약할 변경 사항이 없습니다",
  "dialog.gitGenerate.error.noBranchChanges": "요약할 브랜치 변경 사항이 없습니다",
  "dialog.gitGenerate.error.commitFailed": "커밋 메시지 생성 실패",
  "dialog.gitGenerate.error.prTitleFailed": "PR 제목 생성 실패",
  "dialog.gitGenerate.error.emptyResponse": "모델 응답이 비어 있습니다",
  "dialog.gitGenerate.error.generic": "콘텐츠 생성 실패",
  ...
  "sidebar.gettingStarted.line1": "{{appName}}에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "sidebar.blankProject.title": "새 빈 프로젝트",
  "sidebar.blankProject.nameLabel": "프로젝트 이름",
  "sidebar.blankProject.pathLabel": "생성 위치",
  "sidebar.blankProject.browse": "폴더 선택",
  "sidebar.blankProject.create": "만들기",
  "sidebar.blankProject.createDisabled.path": "생성 위치를 입력하세요",
  "sidebar.blankProject.createDisabled.nameRequired": "프로젝트 이름을 입력하세요",
  "sidebar.blankProject.createDisabled.nameInvalid": "프로젝트 이름에 유효하지 않거나 예약된 문자가 포함되어 있습니다",
  "sidebar.blankProject.error.exists": "해당 위치에 같은 이름의 프로젝트가 이미 있습니다",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 {{appName}} 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "{{appName}} 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 {{appName}}가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "{{appName}}가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "{{appName}} 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "{{appName}}를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 {{appName}}를 사용 중입니다.",
  ...
  "plugins.namespace.dialog.title": "플러그인 namespace 설정",
  "plugins.namespace.dialog.description": "namespace는 게시한 플러그인을 계정과 연결하는 공개 이름입니다.",
  "plugins.namespace.dialog.immutable": "설정한 뒤에는 변경할 수 없으니 계속 사용할 이름을 선택하세요.",
  "plugins.namespace.dialog.placeholder": "your-namespace",
  "plugins.namespace.dialog.action": "namespace 설정",
  "plugins.namespace.dialog.failed": "namespace 설정 실패",
  "plugins.namespace.dialog.noSpaces": "namespace에는 공백을 포함할 수 없습니다.",
  "plugins.namespace.created": "namespace가 설정되었습니다",
  "plugins.namespace.checkFailed": "namespace 확인 실패",
  "plugins.published.title": "게시된 플러그인",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "설정되지 않음",
  "plugins.published.setNamespace": "namespace 설정",
  "plugins.published.namespaceMissing": "플러그인을 게시하기 전에 namespace를 설정하세요.",
  "plugins.published.empty": "아직 게시된 플러그인이 없습니다.",
  "plugins.published.noVersion": "버전 없음",
  "plugins.published.downloads": "다운로드 {{count}}회",
  "plugins.published.delete.action": "플러그인 삭제",
  "plugins.published.delete.success": "플러그인이 삭제되었습니다",
  "plugins.published.delete.failed": "플러그인 삭제 실패",
  "plugins.published.delete.confirm.title": "플러그인 삭제",
  "plugins.published.delete.confirm.description":
    "플러그인 registry에서 {{name}} 및 모든 버전을 삭제합니다.",

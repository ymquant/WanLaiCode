...
export const dict = {
  ...
  "dialog.model.refresh.tooltip": "從服務商取得最新模型列表",
  "dialog.model.refresh.tooltip.loading": "正在取得模型",
  "dialog.model.refresh.toast.success": "模型列表已重新整理",
  "dialog.model.refresh.toast.cached": "未能取得最新模型，已使用快取資料",
  "dialog.model.refresh.toast.failed": "模型列表重新整理失敗",
  "dialog.model.unpaid.wanlaicodeModels.title": "萬來Code 提供的模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 萬來Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 萬來Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 萬來Code 中使用 {{provider}} 模型。",
  ...
  "prompt.imageGeneration.placeholder": "描述要生成的圖片。需要時可加入參考圖",
  "prompt.imageGeneration.count": "{{count}} 張",
  ...
  "prompt.imageGeneration.size.title": "選擇尺寸",
  "prompt.imageGeneration.size.description": "自訂尺寸會自動調整到閘道相容範圍",
  "prompt.imageGeneration.size.width": "寬",
  "prompt.imageGeneration.size.height": "高",
  "prompt.imageGeneration.size.apply": "套用",
  "prompt.imageGeneration.toast.promptRequired.title": "請輸入圖片描述",
  "prompt.imageGeneration.toast.promptRequired.description": "描述你希望圖片模型生成的內容。",
  "prompt.imageGeneration.toast.addToChatUnsupported.title": "圖片生成不能使用已選聊天片段",
  "prompt.imageGeneration.toast.addToChatUnsupported.description": "移除已選片段後，直接傳送圖片生成提示詞。",
  "prompt.imageGeneration.toast.busy.title": "圖片生成正在進行",
  "prompt.imageGeneration.toast.busy.description": "請等待目前回合完成後再開始新的圖片生成。",
  "prompt.imageGeneration.toast.failed.title": "圖片生成失敗",
  "prompt.imageGeneration.toast.noModel.title": "沒有可用的圖片模型",
  "prompt.imageGeneration.toast.noModel.description": "請啟用或連線一個支援圖片生成的模型。",
  "prompt.imageGeneration.toast.compactUnsupported.description": "圖片模型不能用於壓縮，請先選擇一個文字模型。",
  "prompt.imageGeneration.message.loading": "正在生成更細緻的圖片，請稍候。",
  "prompt.imageGeneration.message.failed": "圖片生成失敗：",
  // 套餐能力拒絕與工作階段內的結構化升級卡保持一致，不再提示聯絡管理員。
  "prompt.imageGeneration.error.groupDisabled": "目前套餐不支援圖片生成",
  ...
  "prompt.context.reviewComments": "{{count}} 個評論",
  "prompt.action.attachFile": "附加檔案",
  "prompt.goal.label": "追求目標",
  "prompt.attachment.remove": "移除附件",
  "prompt.attachment.pastedText": "貼上的文字",
  "prompt.attachment.pastedJson": "貼上的 JSON",
  "prompt.attachment.showInTextField": "在文字框中顯示",
  "prompt.attachment.preview.save": "儲存",
  "prompt.attachment.preview.close": "關閉預覽",
  "prompt.attachment.preview.openExternal": "在外部開啟",
  "prompt.attachment.preview.unsaved": "尚未儲存",
  "prompt.attachment.preview.saving": "儲存中…",
  "prompt.attachment.preview.saveFailed": "儲存貼上附件失敗",
  "prompt.attachment.preview.invalidJson": "不符合JSON格式，無法儲存",
  "prompt.attachment.preview.loadFailed": "載入貼上附件失敗",
  "prompt.action.send": "傳送",
  "prompt.action.stop": "停止",

  "prompt.toast.pasteUnsupported.title": "不支援的附件",
  "prompt.toast.pasteUnsupported.description": "此處僅能附加圖片、PDF 或文字檔案。",
  "prompt.toast.pastedTextRestoreFailed.title": "無法還原貼上的文字",
  ...
  "prompt.toast.noPlanModelBlocked.title": "需要開通套餐",
  "prompt.toast.noPlanModelBlocked.description":
    "目前模型需要有效套餐。新用戶可免費使用 DeepSeek 模型，或前往個人中心開通套餐。",
  ...
  "dialog.plugins.empty": "在 wanlaicode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 萬來Code 伺服器。",
  ...
  "toast.update.description": "萬來Code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 萬來Code 團隊",
  "error.page.report.community": "在社群",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (wanlaicode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: 萬來Code 暫不支援 MCP 認證。',
  ...
  "session.review.noUnstagedChanges": "暫無未暫存的變更",
  "session.review.noStagedChanges": "暫無已暫存的變更",
  "session.review.noBranchChanges": "暫無分支上的變更",
  ...
  "session.followupDock.sendNow": "引導",
  "session.followupDock.sendNowTooltip": "不打斷目前模型提交",
  "session.followupDock.sendNowCompacting": "正在壓縮會話，壓縮完成後才能引導",
  "session.followupDock.edit": "編輯",
  "session.followupDock.deleteQueued": "刪除佇列訊息",
  "session.followupDock.deleteReady": "刪除待引導訊息",
  "session.followupDock.moreQueued": "佇列訊息操作",
  "session.followupDock.moreReady": "待引導訊息操作",
  "session.followupDock.reorderQueued": "拖曳排序佇列訊息",
  "session.followupDock.reorderReady": "拖曳排序待引導訊息",
  "session.followupDock.reorderFailed": "拖曳排序失敗的待引導訊息",
  "session.followupDock.turnOffQueueing": "關閉佇列",
  "session.followupDock.turnOnQueueing": "開啟佇列",
  ...
  "session.new.codex.title": "要在 {{project}} 中建構什麼？",
  "session.new.codex.title.noProject": "我們該做什麼？",
  "session.new.project.picker": "為新對話選擇專案",
  "session.new.project.empty": "進入專案工作",
  "session.new.project.search": "搜尋專案",
  "session.new.project.detach": "不使用專案",
  "session.new.worktree.label": "選擇分支",
  "session.new.worktree.branches": "分支",
  "session.new.worktree.main": "主分支",
  "session.new.worktree.mainWithBranch": "主分支 ({{branch}})",
  "session.new.worktree.create": "建立並檢出新分支...",
  "session.new.worktree.search": "搜尋分支",
  "session.new.worktree.uncommitted": "未提交：{{count}} 個檔案",
  "session.new.worktree.clean": "無未提交",
  "session.new.worktree.pendingCreate": "送出對話時建立",
  "session.new.worktree.switchFailed": "切換分支失敗",
  "branch.details.card.title": "環境信息",
  "branch.details.card.unpin": "取消固定",
  "branch.details.card.changes": "變更",
  "branch.details.card.gitOps": "Git 操作",
  "branch.details.card.commit": "提交",
  "branch.details.card.push": "推送",
  "branch.details.card.createBranch": "建立分支",
  "branch.details.card.nothingToCommit": "無可提交的變更",
  "branch.details.card.nothingToPush": "暫無新提交可推送",
  "branch.details.card.createPullRequest": "創建拉取請求",
  "branch.details.card.openPullRequest": "在瀏覽器中打開拉取請求",
  "branch.details.card.prLoading": "正在檢查拉取請求狀態…",
  "branch.details.card.prRefreshFailed": "無法檢查拉取請求狀態，點擊重試",
  "branch.details.card.refreshPullRequest": "刷新拉取請求狀態",
  "branch.details.card.prUnavailable": "無法取得拉取請求狀態",
  "branch.details.card.installGhCliPrompt": "安裝 GitHub CLI",
  "branch.details.card.installGhCliClickHint": "點擊以開始安裝",
  "branch.details.card.authGhCliPrompt": "登入 GitHub 完成授權 GitHub CLI",
  "branch.details.card.pastePromptUnavailable": "會話輸入欄尚未就緒，請稍後再試",
  "branch.details.card.generated": "生成結果",
  "branch.details.card.output": "輸出",
  "branch.details.card.output.none": "暫無產物",
  "branch.details.card.output.showMore": "再顯示 {{count}} 個",
  "branch.details.card.output.collapse": "收起",
  "branch.details.card.sources": "來源",
  "branch.details.card.sources.webSearch": "網絡搜索",
  "branch.details.card.sources.none": "暫無來源",
  "toast.git.createPullRequest.success": "拉取請求已建立。",
  "dialog.createPullRequest.title": "創建 PR",
  "dialog.createPullRequest.row.changes": "變更",
  "dialog.createPullRequest.row.branchFlow": "{{source}} -> {{target}}",
  "dialog.createPullRequest.field.title": "標題",
  "dialog.createPullRequest.field.titlePlaceholder": "PR 標題（留空將自動產生）",
  "dialog.createPullRequest.field.body": "描述",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR 描述（留空將自動產生）",
  "dialog.createPullRequest.noChanges.branch": "目前分支相對預設分支沒有可總結的變更。",
  "dialog.createPullRequest.steps": "後續步驟",
  "dialog.createPullRequest.option.create": "創建 PR",
  "dialog.createPullRequest.option.pushAndCreate": "推送並創建 PR",
  "dialog.createPullRequest.option.commitPushAndCreate": "提交、推送並創建 PR",
  "dialog.createPullRequest.draft": "草稿",
  "dialog.createPullRequest.action.openPage": "打開 PR 頁面",
  "dialog.createPullRequest.action.submit": "創建拉取請求",
  "dialog.createPullRequest.action.submitting": "建立中…",
  "dialog.createPullRequest.toast.failed": "建立拉取請求失敗",
  "dialog.createPullRequest.unlock.no-git": "目前目錄不是 Git 儲存庫",
  "dialog.createPullRequest.unlock.gh-cli": "未安裝 GitHub CLI (gh)",
  "dialog.createPullRequest.unlock.gh-auth": "GitHub CLI 未通過身份驗證",
  "dialog.createPullRequest.unlock.remote": "未設定遠端儲存庫",
  "dialog.createPullRequest.unlock.branch": "無法取得目前分支",
  "dialog.createPullRequest.unlock.no-changes": "無可提交的變更",
  "dialog.createPullRequest.unlock.no-commits": "目前分支尚無提交",
  "dialog.createPullRequest.unlock.nothing-to-push": "暫無新提交可推送",
  "dialog.createPullRequest.unlock.branch-not-on-remote": "目前分支尚未推送到遠端",
  "dialog.createPullRequest.unlock.branch-not-pushed": "仍有未推送的提交，請先推送",
  "dialog.createPullRequest.unlock.push-for-web": "推送分支以在 GitHub 中查看 PR 頁面",
  "dialog.createPullRequest.unlock.uncommitted-changes": "仍有未提交的變更，請先提交",
  "dialog.createPullRequest.unlock.existing-pull-request": "已有開啟的拉取請求",
  "common.comingSoon": "即將上線",
  "dialog.commit.title": "提交變更",
  "dialog.commit.row.branch": "分支",
  "dialog.commit.row.changes": "變更",
  "dialog.commit.row.filesCount": "{{count}} 個檔案",
  "dialog.commit.row.includeUnstaged": "包含未暫存的變更",
  "dialog.commit.noChanges.stagedOnly": "目前範圍內沒有已暫存的變更。請先暫存檔案，或開啟「包含未暫存的變更」。",
  "dialog.commit.noChanges.all": "目前沒有未提交的變更。",
  "dialog.commit.field.message": "提交訊息",
  "dialog.commit.field.placeholder": "提交資訊（留空將自動產生）",
  "dialog.commit.action.continue": "繼續",
  "dialog.commit.action.submit": "提交",
  "dialog.commit.action.submitting": "提交中...",
  "dialog.commit.defaultMessage": "chore: 更新",
  "dialog.commit.toast.failed": "提交失敗",
  "dialog.commit.toast.noChanges.title": "無法提交",
  "dialog.gitGenerate.action.generate": "產生",
  "dialog.gitGenerate.action.generating": "產生中…",
  "dialog.gitGenerate.toast.failed": "產生失敗",
  "dialog.gitGenerate.toast.noChanges.title": "無法產生",
  "dialog.gitGenerate.toast.empty": "未產生有效內容，請確認有程式碼變更且已設定模型",
  "dialog.gitGenerate.error.noChanges": "沒有可總結的變更",
  "dialog.gitGenerate.error.noBranchChanges": "沒有可總結的分支變更",
  "dialog.gitGenerate.error.commitFailed": "產生提交訊息失敗",
  "dialog.gitGenerate.error.prTitleFailed": "產生 PR 標題失敗",
  "dialog.gitGenerate.error.emptyResponse": "模型回應為空",
  "dialog.gitGenerate.error.generic": "產生內容失敗",
  "toast.git.push.success": "分支已推送。",
  "toast.git.push.failed": "推送失敗",
  "dialog.push.title": "推送變更",
  "dialog.push.row.branch": "分支",
  "dialog.push.description": "將你最新的提交內容推送至遠端程式碼倉庫。",
  "dialog.push.steps": "後續步驟",
  "dialog.push.option.push": "推送",
  "dialog.push.option.commitAndPush": "提交並推送",
  "dialog.push.action.continue": "繼續",
  "dialog.pushFailed.title": "無法推送變更",
  "dialog.pushFailed.empty": "（無輸出）",
  "dialog.pushFailed.forcePush": "強制推送",
  "session.new.lastModified": "最後修改",

  "session.header.search.placeholder": "搜尋 {{project}}",
  "session.header.searchFiles": "搜尋檔案",
  "session.header.togglePinnedSummary": "切換置頂摘要",
  ...
  "sidebar.gettingStarted.line1": "萬來Code 提供免費模型，你可以立即開始使用。",
  ...
  "sidebar.blankProject.title": "新建空白專案",
  "sidebar.blankProject.nameLabel": "專案名稱",
  "sidebar.blankProject.pathLabel": "建立位置",
  "sidebar.blankProject.browse": "選擇資料夾",
  "sidebar.blankProject.create": "建立",
  "sidebar.blankProject.createDisabled.path": "請填寫建立位置",
  "sidebar.blankProject.createDisabled.nameRequired": "請填寫專案名稱",
  "sidebar.blankProject.createDisabled.nameInvalid": "專案名稱包含無效或系統保留字元",
  "sidebar.blankProject.error.exists": "該位置已存在同名專案",

  "app.name.desktop": "萬來Code Desktop",
  "settings.section.desktop": "桌面",
  "settings.section.server": "伺服器",
  "settings.section.archived": "已歸檔",

  "settings.tab.general": "一般",
  "settings.tab.shortcuts": "快速鍵",
  "settings.memory.title": "記憶",
  "settings.archivedSessions.title": "已歸檔對話",
  "settings.archivedSessions.search.placeholder": "搜尋已歸檔聊天",
  "settings.archivedSessions.deleteAll": "全部刪除",
  "settings.archivedSessions.deleteAll.confirm.title.all": "刪除所有已歸檔聊天？",
  "settings.archivedSessions.deleteAll.confirm.title.local": "刪除所有已歸檔本地聊天？",
  "settings.archivedSessions.deleteAll.confirm.title.cloud": "刪除所有已歸檔雲端聊天？",
  "settings.archivedSessions.deleteAll.confirm.description.all": "這將永久刪除所有已歸檔聊天記錄",
  "settings.archivedSessions.deleteAll.confirm.description.local": "這將永久刪除所有本地已歸檔聊天記錄",
  "settings.archivedSessions.deleteAll.confirm.description.cloud": "這將永久刪除所有雲端已歸檔聊天記錄",
  "settings.archivedSessions.deleteProject.confirm.title": "刪除此專案中的已歸檔對話？",
  "settings.archivedSessions.deleteProject.confirm.description": "將永久刪除「{{name}}」中的 {{count}} 個已歸檔對話，此操作無法復原。",
  "settings.archivedSessions.menu.deleteProject": "刪除專案中的全部內容",
  "settings.archivedSessions.filter.type.section": "類型",
  "settings.archivedSessions.filter.type.all": "全部聊天",
  "settings.archivedSessions.filter.type.local": "本機",
  "settings.archivedSessions.filter.type.cloud": "雲端",
  "settings.archivedSessions.filter.sort.section": "排序方式",
  "settings.archivedSessions.filter.sort.updated": "更新時間",
  "settings.archivedSessions.filter.sort.created": "建立時間",
  "settings.archivedSessions.filter.sort.alpha": "依字母順序",
  "settings.archivedSessions.filter.project.all": "全部專案",
  "settings.archivedSessions.filter.project.chats": "對話",
  "settings.archivedSessions.filter.project.automations": "自動化",
  "settings.archivedSessions.group.chatCount": "{{count}} 個聊天",
  "settings.archivedSessions.empty": "暫無已歸檔對話",
  "settings.archivedSessions.load.failed": "載入已歸檔對話失敗",
  "settings.archivedSessions.load.truncated": "已歸檔對話過多，僅顯示最近的一部分。搜尋與篩選僅作用於當前已載入列表；批次刪除已停用。",
  "settings.archivedSessions.deleteAll.disabled.truncated": "列表未完整載入時無法批次刪除",
  "settings.archivedSessions.delete.failed": "刪除已歸檔對話失敗",
  "settings.archivedSessions.delete.failed.partial": "有 {{count}} 個對話未能刪除",
  "settings.archivedSessions.delete.one": "刪除已歸檔聊天",
  "settings.archivedSessions.delete.one.confirm.title": "刪除此已歸檔對話？",
  "settings.archivedSessions.delete.one.confirm.description": "將永久刪除「{{name}}」，此操作無法復原。",
  "settings.archivedSessions.unarchive": "取消歸檔",
  "settings.archivedSessions.unarchive.failed": "還原已歸檔對話失敗",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 整合",
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 萬來Code 伺服器。",

  "settings.general.section.general": "常規",
  ...
  "settings.general.row.language.description": "變更 萬來Code 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 萬來Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 萬來Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 萬來Code 的主題。",
  "settings.general.row.font.title": "程式碼字型",
  "settings.general.row.font.description": "自訂程式碼區塊使用的字型",
  "settings.general.row.terminalFont.title": "Terminal Font",
  "settings.general.row.terminalFont.description": "Customise the font used in the terminal",
  "settings.general.row.uiFontSize.title": "UI 字號",
  "settings.general.row.uiFontSize.description": "調整 Codex UI 使用的基準字號",
  ...
  "settings.general.row.translateReasoning.title": "翻譯",
  "settings.general.row.translateReasoning.description":
    "將非當前語言的推理摘要（含子代理內容）翻譯為當前語言；每段翻譯會額外消耗模型 token。",

  "settings.general.row.shell.title": "終端機 Shell",
  "settings.general.row.shell.description": "選擇終端機使用的 shell；相容的 shell 也會用於 Agent 的工具呼叫。",
  ...
  "settings.updates.row.startup.description": "在 萬來Code 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 萬來Code。",
  ...
  "settings.proxy.description": "控制應用程式自身 HTTP 和 HTTPS 請求使用的代理。",
  "settings.proxy.mode.system": "使用系統代理",
  "settings.proxy.mode.manual": "手動代理",
  "settings.proxy.mode.none": "不使用代理",
  "settings.proxy.row.mode.title": "模式",
  "settings.proxy.row.mode.description": "選擇系統代理偵測、手動代理網址或直連。",
  "settings.proxy.row.url.title": "通用代理 URL",
  "settings.proxy.row.url.description": "系統模式顯示目前偵測值；修改後會切換為手動代理。",
  "settings.proxy.placeholder.url": "例如：http://proxy.example:8080",
  "settings.proxy.placeholder.system.url": "未偵測到通用系統代理",
  "settings.proxy.row.httpUrl.title": "HTTP 代理 URL",
  "settings.proxy.row.httpUrl.description": "系統模式顯示目前偵測值；修改後僅覆寫 HTTP 請求。",
  "settings.proxy.placeholder.httpUrl": "可選，僅覆寫 HTTP",
  "settings.proxy.placeholder.system.httpUrl": "未偵測到 HTTP 系統代理",
  "settings.proxy.row.httpsUrl.title": "HTTPS 代理 URL",
  "settings.proxy.row.httpsUrl.description": "系統模式顯示目前偵測值；修改後僅覆寫 HTTPS 請求。",
  "settings.proxy.placeholder.httpsUrl": "可選，僅覆寫 HTTPS",
  "settings.proxy.placeholder.system.httpsUrl": "未偵測到 HTTPS 系統代理",
  "settings.proxy.row.noProxy.title": "繞過地址",
  "settings.proxy.row.noProxy.description": "系統模式顯示目前偵測值；符合的主機將直連。",
  "settings.proxy.placeholder.noProxy": "可選，用英文逗號分隔",
  "settings.proxy.placeholder.system.noProxy": "未偵測到系統繞過地址",
  "settings.proxy.error.invalidUrl": "代理位址必須以 http:// 或 https:// 開頭。",
  "login.proxy.button": "代理設定",
  "login.proxy.title": "代理設定",
  "login.proxy.description": "需要透過代理才能存取時在此設定；預設不使用代理。",
  ...
  "session.archived.notAvailable": "此對話已封存，請在設定的「已封存對話」中查看。",
  "session.archived.lookupFailed": "無法驗證工作階段狀態，請檢查網路後重試。",
  ...
  "settings.personalization.title": "個性化",
  "settings.personalization.customInstructions.title": "自訂指令",
  "settings.personalization.customInstructions.description": "為你的專案向 Codex 提供額外說明和上下文。",
  "settings.personalization.customInstructions.placeholder": "新增自訂指令...",
  "settings.git.row.branchPrefix.title": "分支前綴",
  "settings.git.row.branchPrefix.description": "在 Codex 中建立新分支時使用的前綴",
  "dialog.branch.switch.title": "提交變更以切換分支",
  "dialog.branch.switch.overwriteWarning": "你對以下檔案的變更將被檢出操作覆寫：",
  "dialog.branch.switch.commitHint": "請提交變更以繼續",
  "dialog.branch.switch.action.cancel": "取消",
  "dialog.branch.switch.action.commitAndSwitch": "提交並切換分支…",

  "dialog.branch.create.title": "建立並檢出分支",
  "dialog.branch.create.action.configurePrefix": "設定前綴",
  "dialog.branch.create.action.submit": "建立並檢出",
  "dialog.branch.create.action.submitting": "建立中...",
  "dialog.branch.create.toast.failed.title": "建立分支失敗",
  "dialog.branch.create.field.name": "分支名稱",
  "dialog.branch.create.error.empty": "請輸入分支名。",
  "dialog.branch.create.error.trailingSlash": '分支名不能以 "/" 結尾。',
  "dialog.branch.create.error.invalidChars": "分支名包含非法字元。",
  "dialog.branch.create.error.exists": "同名分支已存在。",
  "session.goal.title": "目標",
  "session.goal.collapse": "收起",
  "session.goal.expand": "展開",
  "session.goal.edit": "編輯目標",
  "session.goal.pause": "暫停",
  "session.goal.resume": "繼續",
  "session.goal.clear": "清除目標",
  "session.goal.status.active": "進行中的目標",
  "session.goal.status.paused": "已暫停的目標",
  "session.goal.status.blocked": "目標受阻",
  "session.goal.status.usageLimited": "目標用量受限",
  "session.goal.status.budgetLimited": "目標受限",
  "session.goal.status.complete": "目標已達成",
  "session.goal.chip": "目標",
  "session.goal.chip.clear": "清除目標",
  "session.goal.chip.tooltip": "明確目標",
  "session.goal.achieved": "已在 {{totalTime}} 內達成目標",
  "session.goal.dialog.edit.title": "編輯目標",
  "session.goal.dialog.edit.placeholder": "描述本會話的目標",
  "session.goal.dialog.edit.save": "儲存",
  "session.goal.dialog.replace.title": "替換目前的目標？",
  "session.goal.dialog.replace.description": "將保留目前的會話，但以輸入框中的文字替換已儲存的目標",
  "session.goal.dialog.replace.confirm": "替換目標",
  "session.goal.dialog.resume.title": "恢復目標？",
  "session.goal.dialog.resume.description": "當會話閒置時，{{appName}} 會繼續朝該目標推進",
  "session.goal.dialog.resume.confirm": "恢復目標",
  "session.goal.dialog.resume.cancel": "暫不",
  "command.session.goal": "設定目標",
  "command.session.goal.description": "為本會話設定一個自治目標",
  "users.actions.generateKey": "生成密鑰",
  "users.notice.keyGenerated": "密鑰已生成",
  // 個人中心僅在目前權益明確開啟圖片生成能力時顯示此標籤。
  "users.quota.imageGenerationSupported": "支援圖片生成",
  ...
  "users.balanceBilling.section": "餘額扣費",
  "users.balanceBilling.title": "使用帳戶餘額付費",
  "users.balanceBilling.description": "當沒有可用方案時，使用產生的費用將從帳戶餘額中扣除。預設關閉。",
  "users.balanceBilling.toast.enabled": "已開啟餘額扣費",
  "users.balanceBilling.toast.disabled": "已關閉餘額扣費",
  "users.balanceBilling.toast.updateFailed": "更新餘額扣費開關失敗",
  "users.balanceBilling.dialog.title": "選擇使用方式",
  "users.balanceBilling.dialog.description":
    "目前沒有可用方案。你可以開通方案享受更多權益，或開啟餘額扣費按量使用，費用將從帳戶餘額中扣除。",
  "users.balanceBilling.dialog.confirm": "開啟餘額扣費",
  "users.balanceBilling.dialog.purchasePlan": "開通方案",
  "plugins.subtitle": "在你常用的工具中使用 萬來 Code",
  "plugins.section.installed": "已安裝",
  "plugins.source.byBuiltin": "由 {{name}} 提供",
  "plugins.source.byWorkspace": "工作區",
  "plugins.source.personal": "個人",
  "plugins.seeMore": "查看 {{names}} 等另外 {{count}} 個",
  "plugins.card.more": "更多",
  "plugins.category.filter": "依分類篩選",
  "plugins.category.productivity": "效率",
  "plugins.category.communication": "溝通",
  "plugins.category.business": "商務與營運",
  "plugins.category.creativity": "創意",
  "plugins.category.dataAnalytics": "資料與分析",
  "plugins.category.design": "設計",
  "plugins.category.developerTools": "開發者工具",
  "plugins.category.education": "教育與研究",
  ...
  "plugins.hero.tryInChat": "在對話中試用",
  "plugins.skills.comingSoon": "技能即將推出",
  "plugins.skills.title": "技能",
  "plugins.skills.subtitle": "用面向任務的技能擴展 萬來 Code 的能力",
  "plugins.skills.search.placeholder": "搜尋技能",
  "plugins.skills.source.all": "全部",
  "plugins.skills.section.personal": "個人",
  "plugins.skills.source.system": "系統",
  "plugins.skills.source.recommended": "推薦",
  "plugins.skills.source.empty": "這裡還沒有技能",
  "plugins.skills.enable": "啟用",
  "plugins.skills.disable": "停用",
  "plugins.skills.toggle.failed": "切換失敗",
  "plugins.skills.error.load": "載入技能失敗",
  "plugins.skills.empty.title": "暫無技能",
  "plugins.skills.empty.description": "安裝一個包含技能的插件後，它們會在這裡顯示。",
  "plugins.skills.empty.search": "沒有匹配的技能。",
  "plugins.skills.create.button": "新增技能",
  "plugins.skills.create.title": "新增本地技能",
  "plugins.skills.create.addon": "所屬插件",
  "plugins.skills.create.name": "名稱",
  "plugins.skills.create.nameHint": "僅允許小寫字母、數字和短橫線。",
  "plugins.skills.create.displayName": "顯示名稱（可選）",
  "plugins.skills.create.description": "描述（必填）",
  "plugins.skills.create.content": "內容（Markdown）",
  "plugins.skills.create.contentPlaceholder": "技能內容…",
  "plugins.skills.badge.builtin": "內建",
  "plugins.skills.create.cancel": "取消",
  "plugins.skills.create.submit": "建立",
  "plugins.skills.create.submitting": "建立中…",
  "plugins.skills.create.failed": "建立失敗",
  "plugins.skills.create.succeeded": "已建立技能",
  "plugins.skills.create.noAddon": "請先安裝一個插件，再在其下建立技能。",
  "plugins.install": "安裝",
  "plugins.uninstall.failed": "卸載失敗",
  "plugins.menu.more": "更多",
  "plugins.menu.refresh": "刷新",
  "plugins.menu.add": "添加",
  "plugins.menu.createPlugin": "創建插件",
  "plugins.createSkill.prompt": "[Skill Creator](skill://skill-creator) ",
  "plugins.menu.addMarketplace": "添加 Marketplace",
  "plugins.menu.recordSkill": "錄製技能",
  "plugins.menu.createSkill": "創建技能",
  "plugins.detail.upload.action": "上傳到插件後端",
  "plugins.detail.upload.uploading": "上傳中…",
  "plugins.detail.upload.success": "插件上傳成功",
  "plugins.detail.upload.failed": "插件上傳失敗",
  "plugins.namespace.dialog.title": "設定插件 namespace",
  "plugins.namespace.dialog.description": "namespace 是你發布插件時對外展示的帳戶識別，使用者會透過它辨識插件歸屬。",
  "plugins.namespace.dialog.immutable": "namespace 設定後不可修改，請選擇一個你希望長期使用的名稱。",
  "plugins.namespace.dialog.placeholder": "your-namespace",
  "plugins.namespace.dialog.action": "設定 namespace",
  "plugins.namespace.dialog.failed": "設定 namespace 失敗",
  "plugins.namespace.dialog.noSpaces": "namespace 不能包含空格。",
  "plugins.namespace.created": "namespace 已設定",
  "plugins.namespace.checkFailed": "檢查 namespace 失敗",
  "plugins.published.title": "已發布插件",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "未設定",
  "plugins.published.setNamespace": "設定 namespace",
  "plugins.published.namespaceMissing": "發布插件前需要先設定 namespace。",
  "plugins.published.empty": "還沒有已發布插件。",
  "plugins.published.noVersion": "暫無版本",
  "plugins.published.downloads": "{{count}} 次下載",
  "plugins.published.delete.action": "刪除插件",
  "plugins.published.delete.success": "插件已刪除",
  "plugins.published.delete.failed": "刪除插件失敗",
  "plugins.published.delete.confirm.title": "刪除插件",
  "plugins.published.delete.confirm.description": "從插件後端刪除 {{name}} 及其所有版本。",
  "plugins.detail.versions.title": "歷史版本",
  "plugins.detail.versions.manage": "管理版本",
  "plugins.detail.versions.loading": "載入版本中…",
  "plugins.detail.versions.count": "{{count}} 個版本",
  "plugins.detail.versions.empty": "還沒有已發布版本。",
  "plugins.detail.versions.meta": "{{size}} · {{downloads}} 次下載",
  "plugins.detail.versions.delete": "刪除版本",
  "plugins.detail.versions.deleteSuccess": "版本已刪除",
  "plugins.detail.versions.deleteFailed": "刪除版本失敗",
  "plugins.detail.versions.openFailed": "打開版本管理失敗",
  "plugins.detail.versions.deleteConfirm.title": "刪除版本",
  "plugins.detail.versions.deleteConfirm.description": "從插件後端刪除版本 {{version}}。",
  "plugins.detail.stats.installs": "{{count}} 次安裝",
  "plugins.detail.uninstall": "卸載",
  "plugins.detail.includes.skill": "技能",
  "plugins.detail.info.namespace": "命名空間",
  "plugins.migrate": "遷移",
  "plugins.migrate.failed": "遷移失敗",
  "plugins.migrate.success": "遷移成功",
  "plugins.migrate.title": "遷移到官方市場版本",
  "plugins.migrate.tooltip":
    "這個插件來自舊的 openai/plugins 來源，或缺少命名空間資訊。遷移會安裝官方市場版本，並在安裝成功後刪除舊版本。",

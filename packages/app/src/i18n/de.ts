...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in {{appName}} zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in {{appName}} zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in {{appName}} zu nutzen.",
  ...
  "dialog.plugins.empty": "In wanlaicode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den {{appName}}-Server, mit dem sich diese App verbindet.",
  ...
  "context.usage.compact.hint": "Komprimieren",
  ...
  "toast.update.description": "Eine neue Version von {{appName}} ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem {{appName}}-Team",
  "error.page.report.community": "in der Community",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (wanlaicode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: {{appName}} unterstützt noch keine MCP-Authentifizierung.',
  ...
  "session.header.togglePinnedSummary": "Angeheftete Zusammenfassung umschalten",
  ...
  "dialog.commit.field.placeholder": "Commit-Nachricht (wird bei leerem Feld automatisch generiert)",
  "dialog.createPullRequest.field.titlePlaceholder": "PR-Titel (wird bei leerem Feld automatisch generiert)",
  "dialog.createPullRequest.field.bodyPlaceholder": "PR-Beschreibung (wird bei leerem Feld automatisch generiert)",
  "dialog.createPullRequest.noChanges.branch": "Dieser Branch hat keine Änderungen gegenüber dem Standard-Branch.",
  "dialog.commit.noChanges.stagedOnly":
    "Im aktuellen Umfang ist nichts gestaged. Dateien zuerst stagen oder „Unstaged-Änderungen einbeziehen“ aktivieren.",
  "dialog.commit.noChanges.all": "Es gibt keine uncommitteten Änderungen.",
  "dialog.commit.toast.noChanges.title": "Commit nicht möglich",
  "dialog.gitGenerate.toast.noChanges.title": "Generierung nicht möglich",
  "dialog.gitGenerate.action.generate": "Generieren",
  "dialog.gitGenerate.action.generating": "Wird generiert…",
  "dialog.gitGenerate.toast.failed": "Generierung fehlgeschlagen",
  "dialog.gitGenerate.toast.empty": "Nichts generiert. Prüfen Sie Codeänderungen und ein konfiguriertes Modell.",
  "dialog.gitGenerate.error.noChanges": "Keine Änderungen zum Zusammenfassen",
  "dialog.gitGenerate.error.noBranchChanges": "Keine Branch-Änderungen zum Zusammenfassen",
  "dialog.gitGenerate.error.commitFailed": "Commit-Nachricht konnte nicht generiert werden",
  "dialog.gitGenerate.error.prTitleFailed": "PR-Titel konnte nicht generiert werden",
  "dialog.gitGenerate.error.emptyResponse": "Leere Modellantwort",
  "dialog.gitGenerate.error.generic": "Inhalt konnte nicht generiert werden",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "sidebar.blankProject.title": "Neues leeres Projekt",
  "sidebar.blankProject.nameLabel": "Projektname",
  "sidebar.blankProject.pathLabel": "Erstellen in",
  "sidebar.blankProject.browse": "Ordner auswählen",
  "sidebar.blankProject.create": "Erstellen",
  "sidebar.blankProject.createDisabled.path": "Ordner für das Projekt angeben",
  "sidebar.blankProject.createDisabled.nameRequired": "Projektname eingeben",
  "sidebar.blankProject.createDisabled.nameInvalid": "Projektname enthält ungültige oder reservierte Zeichen",
  "sidebar.blankProject.error.exists": "In diesem Ordner existiert bereits ein Projekt mit diesem Namen",
  ...
  "settings.desktop.wsl.description": "{{appName}}-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für {{appName}} ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie {{appName}} auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob {{appName}} dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von {{appName}} anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von {{appName}} automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Plugin-namespace festlegen",
  "plugins.namespace.dialog.description": "Der namespace ist der offentliche Name, der veroffentlichte Plugins mit deinem Konto verbindet.",
  "plugins.namespace.dialog.immutable": "Nach dem Festlegen kann er nicht geandert werden. Wahle daher einen Namen, den du behalten mochtest.",
  "plugins.namespace.dialog.placeholder": "dein-namespace",
  "plugins.namespace.dialog.action": "namespace festlegen",
  "plugins.namespace.dialog.failed": "namespace konnte nicht festgelegt werden",
  "plugins.namespace.dialog.noSpaces": "namespace darf keine Leerzeichen enthalten.",
  "plugins.namespace.created": "namespace festgelegt",
  "plugins.namespace.checkFailed": "namespace konnte nicht geprüft werden",
  "plugins.published.title": "Veröffentlichte Plugins",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Nicht festgelegt",
  "plugins.published.setNamespace": "namespace festlegen",
  "plugins.published.namespaceMissing": "Legen Sie vor dem Veröffentlichen von Plugins einen namespace fest.",
  "plugins.published.empty": "Noch keine veröffentlichten Plugins.",
  "plugins.published.noVersion": "Keine Version",
  "plugins.published.downloads": "{{count}} Downloads",
  "plugins.published.delete.action": "Plugin löschen",
  "plugins.published.delete.success": "Plugin gelöscht",
  "plugins.published.delete.failed": "Plugin konnte nicht gelöscht werden",
  "plugins.published.delete.confirm.title": "Plugin löschen",
  "plugins.published.delete.confirm.description":
    "{{name}} und alle Versionen aus der Plugin-Registry löschen.",

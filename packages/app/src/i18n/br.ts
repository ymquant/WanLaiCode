export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no {{appName}}.",
  ...
  "dialog.plugins.empty": "Plugins configurados em wanlaicode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor {{appName}} este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do {{appName}} ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do {{appName}}",
  "error.page.report.community": "na comunidade",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (wanlaicode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: {{appName}} ainda não suporta autenticação MCP.',
  ...
  "session.header.togglePinnedSummary": "Alternar resumo fixado",
  ...
  "dialog.commit.field.placeholder": "Mensagem de commit (gerada automaticamente se deixada em branco)",
  "dialog.createPullRequest.field.titlePlaceholder": "Título do PR (gerado automaticamente se deixado em branco)",
  "dialog.createPullRequest.field.bodyPlaceholder": "Descrição do PR (gerada automaticamente se deixada em branco)",
  "dialog.createPullRequest.noChanges.branch": "Este branch não tem alterações em relação ao branch padrão.",
  "dialog.commit.noChanges.stagedOnly":
    "Nada está staged no escopo atual. Faça stage dos arquivos ou ative \"Incluir alterações não staged\".",
  "dialog.commit.noChanges.all": "Não há alterações não commitadas.",
  "dialog.commit.toast.noChanges.title": "Não é possível commitar",
  "dialog.gitGenerate.toast.noChanges.title": "Não é possível gerar",
  "dialog.gitGenerate.action.generate": "Gerar",
  "dialog.gitGenerate.action.generating": "Gerando…",
  "dialog.gitGenerate.toast.failed": "Falha ao gerar",
  "dialog.gitGenerate.toast.empty": "Nada foi gerado. Verifique alterações no código e um modelo configurado.",
  "dialog.gitGenerate.error.noChanges": "Nenhuma alteração para resumir",
  "dialog.gitGenerate.error.noBranchChanges": "Nenhuma alteração de branch para resumir",
  "dialog.gitGenerate.error.commitFailed": "Falha ao gerar mensagem de commit",
  "dialog.gitGenerate.error.prTitleFailed": "Falha ao gerar título do pull request",
  "dialog.gitGenerate.error.emptyResponse": "Resposta vazia do modelo",
  "dialog.gitGenerate.error.generic": "Falha ao gerar conteúdo",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} inclui modelos gratuitos para você começar imediatamente.",
  ...
  "sidebar.blankProject.title": "Novo projeto em branco",
  "sidebar.blankProject.nameLabel": "Nome do projeto",
  "sidebar.blankProject.pathLabel": "Criar em",
  "sidebar.blankProject.browse": "Escolher pasta",
  "sidebar.blankProject.create": "Criar",
  "sidebar.blankProject.createDisabled.path": "Informe uma pasta para criar o projeto",
  "sidebar.blankProject.createDisabled.nameRequired": "Informe um nome de projeto",
  "sidebar.blankProject.createDisabled.nameInvalid": "O nome contém caracteres inválidos ou reservados",
  "sidebar.blankProject.error.exists": "Já existe um projeto com esse nome nessa pasta",
  ...
  "settings.desktop.wsl.description": "Executar o servidor {{appName}} dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do {{appName}}",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o {{appName}} aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o {{appName}} segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o {{appName}} é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o {{appName}} iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "Definir namespace do plugin",
  "plugins.namespace.dialog.description": "O namespace e o nome publico que vincula plugins publicados a sua conta.",
  "plugins.namespace.dialog.immutable": "Depois de definido, ele nao pode ser alterado; escolha um nome que voce queira manter.",
  "plugins.namespace.dialog.placeholder": "seu-namespace",
  "plugins.namespace.dialog.action": "Definir namespace",
  "plugins.namespace.dialog.failed": "Falha ao definir namespace",
  "plugins.namespace.dialog.noSpaces": "namespace não pode conter espaços.",
  "plugins.namespace.created": "namespace definido",
  "plugins.namespace.checkFailed": "Falha ao verificar namespace",
  "plugins.published.title": "Plugins publicados",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "Não definido",
  "plugins.published.setNamespace": "Definir namespace",
  "plugins.published.namespaceMissing": "Defina um namespace antes de publicar plugins.",
  "plugins.published.empty": "Ainda não há plugins publicados.",
  "plugins.published.noVersion": "Sem versão",
  "plugins.published.downloads": "{{count}} downloads",
  "plugins.published.delete.action": "Excluir plugin",
  "plugins.published.delete.success": "Plugin excluído",
  "plugins.published.delete.failed": "Falha ao excluir plugin",
  "plugins.published.delete.confirm.title": "Excluir plugin",
  "plugins.published.delete.confirm.description":
    "Excluir {{name}} e todas as versões do registro de plugins.",

export const dict = {
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน {{appName}}",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน {{appName}}",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน {{appName}}",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน wanlaicode.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ {{appName}} ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "context.usage.compact.hint": "ย่อ",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ {{appName}} ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม {{appName}}",
  "error.page.report.community": "ในชุมชน",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (wanlaicode.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed":
    'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า {{appName}} ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "session.header.togglePinnedSummary": "สลับสรุปที่ปักหมุด",
  ...
  "dialog.commit.field.placeholder": "ข้อความ commit (จะสร้างอัตโนมัติหากปล่อยว่าง)",
  "dialog.createPullRequest.field.titlePlaceholder": "ชื่อ PR (จะสร้างอัตโนมัติหากปล่อยว่าง)",
  "dialog.createPullRequest.field.bodyPlaceholder": "คำอธิบาย PR (จะสร้างอัตโนมัติหากปล่อยว่าง)",
  "dialog.createPullRequest.noChanges.branch": "สาขานี้ไม่มีการเปลี่ยนแปลงเมื่อเทียบกับสาขาเริ่มต้น",
  "dialog.commit.noChanges.stagedOnly":
    "ไม่มีไฟล์ที่ staged ในขอบเขตปัจจุบัน ให้ stage ไฟล์ก่อน หรือเปิด \"รวมการเปลี่ยนแปลงที่ยังไม่ staged\"",
  "dialog.commit.noChanges.all": "ไม่มีการเปลี่ยนแปลงที่ยังไม่ commit",
  "dialog.commit.toast.noChanges.title": "ไม่สามารถ commit ได้",
  "dialog.gitGenerate.toast.noChanges.title": "ไม่สามารถสร้างได้",
  "dialog.gitGenerate.action.generate": "สร้าง",
  "dialog.gitGenerate.action.generating": "กำลังสร้าง…",
  "dialog.gitGenerate.toast.failed": "สร้างไม่สำเร็จ",
  "dialog.gitGenerate.toast.empty": "ไม่ได้สร้างเนื้อหา ตรวจสอบการเปลี่ยนแปลงโค้ดและโมเดลที่ตั้งค่าไว้",
  "dialog.gitGenerate.error.noChanges": "ไม่มีการเปลี่ยนแปลงให้สรุป",
  "dialog.gitGenerate.error.noBranchChanges": "ไม่มีการเปลี่ยนแปลงสาขาให้สรุป",
  "dialog.gitGenerate.error.commitFailed": "สร้างข้อความ commit ไม่สำเร็จ",
  "dialog.gitGenerate.error.prTitleFailed": "สร้างชื่อ PR ไม่สำเร็จ",
  "dialog.gitGenerate.error.emptyResponse": "การตอบกลับจากโมเดลว่างเปล่า",
  "dialog.gitGenerate.error.generic": "สร้างเนื้อหาไม่สำเร็จ",
  ...
  "sidebar.gettingStarted.line1": "{{appName}} รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "sidebar.blankProject.title": "โปรเจกต์เปล่าใหม่",
  "sidebar.blankProject.nameLabel": "ชื่อโปรเจกต์",
  "sidebar.blankProject.pathLabel": "สร้างใน",
  "sidebar.blankProject.browse": "เลือกโฟลเดอร์",
  "sidebar.blankProject.create": "สร้าง",
  "sidebar.blankProject.createDisabled.path": "กรอกโฟลเดอร์สำหรับสร้างโปรเจกต์",
  "sidebar.blankProject.createDisabled.nameRequired": "กรอกชื่อโปรเจกต์",
  "sidebar.blankProject.createDisabled.nameInvalid": "ชื่อโปรเจกต์มีอักขระที่ไม่ถูกต้องหรือสงวนไว้",
  "sidebar.blankProject.error.exists": "มีโปรเจกต์ชื่อนี้อยู่ในโฟลเดอร์แล้ว",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ {{appName}} ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ {{appName}}",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ {{appName}} มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ {{appName}} ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ {{appName}} มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ {{appName}} เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน {{appName}} เวอร์ชันล่าสุด",
  ...
  "plugins.namespace.dialog.title": "ตั้งค่า namespace ของปลั๊กอิน",
  "plugins.namespace.dialog.description": "namespace คือชื่อสาธารณะที่เชื่อมปลั๊กอินที่เผยแพร่กับบัญชีของคุณ",
  "plugins.namespace.dialog.immutable": "เมื่อตั้งค่าแล้วจะเปลี่ยนไม่ได้ โปรดเลือกชื่อที่ต้องการใช้ต่อไป",
  "plugins.namespace.dialog.placeholder": "your-namespace",
  "plugins.namespace.dialog.action": "ตั้งค่า namespace",
  "plugins.namespace.dialog.failed": "ตั้งค่า namespace ไม่สำเร็จ",
  "plugins.namespace.dialog.noSpaces": "namespace ต้องไม่มีช่องว่าง",
  "plugins.namespace.created": "ตั้งค่า namespace แล้ว",
  "plugins.namespace.checkFailed": "ตรวจสอบ namespace ไม่สำเร็จ",
  "plugins.published.title": "ปลั๊กอินที่เผยแพร่แล้ว",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "ยังไม่ได้ตั้งค่า",
  "plugins.published.setNamespace": "ตั้งค่า namespace",
  "plugins.published.namespaceMissing": "ตั้งค่า namespace ก่อนเผยแพร่ปลั๊กอิน",
  "plugins.published.empty": "ยังไม่มีปลั๊กอินที่เผยแพร่",
  "plugins.published.noVersion": "ไม่มีเวอร์ชัน",
  "plugins.published.downloads": "ดาวน์โหลด {{count}} ครั้ง",
  "plugins.published.delete.action": "ลบปลั๊กอิน",
  "plugins.published.delete.success": "ลบปลั๊กอินแล้ว",
  "plugins.published.delete.failed": "ลบปลั๊กอินไม่สำเร็จ",
  "plugins.published.delete.confirm.title": "ลบปลั๊กอิน",
  "plugins.published.delete.confirm.description":
    "ลบ {{name}} และทุกเวอร์ชันออกจาก plugin registry",

export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في {{appName}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في {{appName}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في {{appName}}.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في wanlaicode.json",
  ...
  "dialog.server.description": "تبديل خادم {{appName}} الذي يتصل به هذا التطبيق.",
  ...
  "context.usage.compact.hint": "ضغط",
  ...
  "toast.update.description": "نسخة جديدة من {{appName}} ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق {{appName}}",
  "error.page.report.community": "في المجتمع",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (wanlaicode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن {{appName}} لا يدعم مصادقة MCP بعد.',
  ...
  "session.header.togglePinnedSummary": "تبديل الملخص المثبت",
  ...
  "dialog.commit.field.placeholder": "رسالة الالتزام (تُولَّد تلقائيًا إذا تُركت فارغة)",
  "dialog.createPullRequest.field.titlePlaceholder": "عنوان PR (يُولَّد تلقائيًا إذا تُرك فارغًا)",
  "dialog.createPullRequest.field.bodyPlaceholder": "وصف PR (يُولَّد تلقائيًا إذا تُرك فارغًا)",
  "dialog.createPullRequest.noChanges.branch": "لا توجد تغييرات في هذا الفرع مقارنة بالفرع الافتراضي.",
  "dialog.commit.noChanges.stagedOnly":
    "لا يوجد شيء في stage ضمن النطاق الحالي. قم بـ stage للملفات أولًا أو فعّل «تضمين التغييرات غير staged».",
  "dialog.commit.noChanges.all": "لا توجد تغييرات غير committed.",
  "dialog.commit.toast.noChanges.title": "تعذر الالتزام",
  "dialog.gitGenerate.toast.noChanges.title": "تعذر الإنشاء",
  "dialog.gitGenerate.action.generate": "إنشاء",
  "dialog.gitGenerate.action.generating": "جارٍ الإنشاء…",
  "dialog.gitGenerate.toast.failed": "فشل الإنشاء",
  "dialog.gitGenerate.toast.empty": "لم يتم إنشاء أي شيء. تحقق من وجود تغييرات في الكود ونموذج مُعدّ.",
  "dialog.gitGenerate.error.noChanges": "لا توجد تغييرات للتلخيص",
  "dialog.gitGenerate.error.noBranchChanges": "لا توجد تغييرات في الفرع للتلخيص",
  "dialog.gitGenerate.error.commitFailed": "فشل إنشاء رسالة الالتزام",
  "dialog.gitGenerate.error.prTitleFailed": "فشل إنشاء عنوان طلب السحب",
  "dialog.gitGenerate.error.emptyResponse": "استجابة النموذج فارغة",
  "dialog.gitGenerate.error.generic": "فشل إنشاء المحتوى",
  ...
  "sidebar.gettingStarted.line1": "يتضمن {{appName}} نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "sidebar.blankProject.title": "مشروع جديد فارغ",
  "sidebar.blankProject.nameLabel": "اسم المشروع",
  "sidebar.blankProject.pathLabel": "الإنشاء في",
  "sidebar.blankProject.browse": "اختيار مجلد",
  "sidebar.blankProject.create": "إنشاء",
  "sidebar.blankProject.createDisabled.path": "أدخل مجلدًا لإنشاء المشروع",
  "sidebar.blankProject.createDisabled.nameRequired": "أدخل اسم المشروع",
  "sidebar.blankProject.createDisabled.nameInvalid": "اسم المشروع يحتوي على أحرف غير صالحة أو محجوزة",
  "sidebar.blankProject.error.exists": "يوجد مشروع بهذا الاسم في هذا المجلد بالفعل",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم {{appName}} داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ {{appName}}",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور {{appName}} على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان {{appName}} يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة {{appName}}.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل {{appName}}",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من {{appName}}.",
  ...
  "plugins.namespace.dialog.title": "تعيين namespace للإضافة",
  "plugins.namespace.dialog.description": "namespace هو الاسم العلني الذي يربط إضافاتك المنشورة بحسابك.",
  "plugins.namespace.dialog.immutable": "بعد تعيينه لا يمكن تغييره، لذا اختر اسما تريد استخدامه على المدى الطويل.",
  "plugins.namespace.dialog.placeholder": "your-namespace",
  "plugins.namespace.dialog.action": "تعيين namespace",
  "plugins.namespace.dialog.failed": "فشل تعيين namespace",
  "plugins.namespace.dialog.noSpaces": "لا يمكن أن يحتوي namespace على مسافات.",
  "plugins.namespace.created": "تم تعيين namespace",
  "plugins.namespace.checkFailed": "فشل التحقق من namespace",
  "plugins.published.title": "الإضافات المنشورة",
  "plugins.published.namespace": "namespace",
  "plugins.published.namespaceNotSet": "غير معين",
  "plugins.published.setNamespace": "تعيين namespace",
  "plugins.published.namespaceMissing": "عيّن namespace قبل نشر الإضافات.",
  "plugins.published.empty": "لا توجد إضافات منشورة بعد.",
  "plugins.published.noVersion": "لا يوجد إصدار",
  "plugins.published.downloads": "{{count}} تنزيلات",
  "plugins.published.delete.action": "حذف الإضافة",
  "plugins.published.delete.success": "تم حذف الإضافة",
  "plugins.published.delete.failed": "فشل حذف الإضافة",
  "plugins.published.delete.confirm.title": "حذف الإضافة",
  "plugins.published.delete.confirm.description":
    "حذف {{name}} وجميع إصداراته من سجل الإضافات.",

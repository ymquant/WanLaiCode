...
describe("file path helpers", () => {
  test("normalizes file inputs against workspace root", () => {
    ...
    expect(path.normalize("/Users/developer/.codex/skills/skill-creator/SKILL.md")).toBe(
      "/Users/developer/.codex/skills/skill-creator/SKILL.md",
    )
    expect(path.tab("/Users/developer/.codex/skills/skill-creator/SKILL.md")).toBe(
      "file:///Users/developer/.codex/skills/skill-creator/SKILL.md",
    )
    ...
    expect(path.pathFromTab("file://script/beta.ts")).toBe("script/beta.ts")
...
describe("encodeFilePath", () => {
  describe("Linux/Unix paths", () => {
    test("should handle Linux absolute path", () => {
      const linuxPath = "/home/developer/project/README.md"
      ...
      expect(result).toBe("/home/developer/project/README.md")

      const url = new URL(fileUrl)
      expect(url.protocol).toBe("file:")
      expect(url.pathname).toBe("/home/developer/project/README.md")
    })

    test("should handle Linux path with special characters", () => {
      const linuxPath = "/home/developer/file#name with spaces.txt"
      const result = encodeFilePath(linuxPath)
      const fileUrl = `file://${result}`

      expect(() => new URL(fileUrl)).not.toThrow()
      expect(result).toBe("/home/developer/file%23name%20with%20spaces.txt")
    })
  ...
  describe("macOS paths", () => {
    test("should handle macOS absolute path", () => {
      const macPath = "/Users/developer/Projects/opencode/README.md"
      const result = encodeFilePath(macPath)
      const fileUrl = `file://${result}`

      expect(() => new URL(fileUrl)).not.toThrow()
      expect(result).toBe("/Users/developer/Projects/opencode/README.md")
    })

    test("should handle macOS path with spaces", () => {
      const macPath = "/Users/developer/My Documents/file.txt"
      const result = encodeFilePath(macPath)
      const fileUrl = `file://${result}`
  ...
  describe("Edge cases", () => {
    ...
    test("should encode Unicode characters", () => {
      const unicodePath = "/home/developer/文档/README.md"
    ...
    test("should handle Windows path with trailing backslash", () => {
      ...
      expect(() => new URL(fileUrl)).not.toThrow()
      expect(result).toBe("/C:/Users/developer/")
    })
  ...
  describe("Integration with file:// URL construction", () => {
    test("should work with query parameters (Linux)", () => {
      const path = "/home/developer/file.txt"
      ...
      expect(url.pathname).toBe("/home/developer/file.txt")
    })

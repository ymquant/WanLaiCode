...
const CHANGELOG_BASE_URL = "https://api.wanlai.ai/changelog.json"
...
export function buildChangelogUrl(version: string | undefined): string {
  const normalized = normalizeVersion(version)
  if (!normalized) return CHANGELOG_BASE_URL
  const url = new URL(CHANGELOG_BASE_URL)
...
export const { use: useHighlights, provider: HighlightsProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    const start = (previous: string) => {
      ...
      fetcher(buildChangelogUrl(platform.version), {
